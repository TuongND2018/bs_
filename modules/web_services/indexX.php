...
?>
 <?php
          if($PLoaiKham=='46'){
          	  ...
          	  echo '<div id="patient_info" style="background:#FFFF7B!important" title="'.$DiaChi.'">';
          }
        
          else
          {
          	echo '<div id="patient_info" title="'.$DiaChi.'">';
          }
          ?>
    ...
    <br />
     <div class="profile_container" >
        ...
        <span id="panel_chieucao" class="texts" style="width:30px;"><?=$ChieuCao?></span>
    </div>
    <div class="profile_container">
         <span class="addon" href="#" style="">
          <i class="icon fa"><span>W</span></i>
        </span>
        <span id="panel_canang" class="texts" style="width:30px;"><?=$CanNang?></span>
    </div>
    <div class="profile_container">
         <span class="addon" href="#" style="">
          <i class="icon fa"><span>Ps</span></i>
        </span>
        <span id="panel_ps" class="texts" style="width:30px;"><?=$Ps?></span>
    </div>
     <div class="profile_container">
         <span class="addon" href="#" style="">
          <i class="icon fa"><span>Pd</span></i>
        </span>
        <span id="panel_pd" class="texts" style="width:30px;"><?=$Pd?></span>
    </div>
    <div class="profile_container">
         <span class="addon" href="#" style="">
          <i class="icon fa"><span>Hr</span></i>
        </span>
        <span id="panel_mach" class="texts" style="width:30px;"><?=$Mach?></span>
    </div>
     <div class="profile_container">
         <span class="addon" href="#" style="">
          <i class="icon fa"><span>T</span></i>
        </span>
        <span id="panel_thannhiet" class="texts" style="width:30px;"><?=$ThanNhiet?>&deg;</span>
    </div>
    <span style="position:fixed;top: 45px;">
   <input class="custom_button xanh" type="button" onclick="mobenhnhan()" value="Chỉ định" style="height:22px;width:80px!important;">
   <input class="custom_button xanh" type="button" onclick="moghichu()" value="Ghi chú" style="height:22px;width:80px!important;">
   </span>
     <script>
	function mobenhnhan(){
...
?>
  <div id="patient_info" style="width:760px" title="<?=$DiaChi?>">
   ...
   <input class="<?php
	...
	// }else{
	//	  $tam1=connect_data('GD2_getnotes_bn_byidluotkham',"(?,?)",$params);
	// }
