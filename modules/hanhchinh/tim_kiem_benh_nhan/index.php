...
<div style="margin-top:4px;">
   <div class="ui-dialog ui-widget ui-widget-content ui-corner-all ui-resizable thongtinchinh panel_form" style="margin-left:4px" >
    ...
    <div class="ui-dialog-content ui-widget-content"style="display: block; width: auto; min-height: 70px; max-height: none; height: 100%">
      <div id="container">
...
function create_grid(){
	...
	datatype: "json",
   	colNames:['Id','Mã BN','Họ lót','Tên','Ngày Sinh','Năm sinh','Giới tính','Điện thoại','Địa chỉ','Nghề nghiệp','Người liên hệ','Quan hệ với BN','ĐT người LH','Ghi chú'],
   	colModel:[
		...
		{name:'ID_NgheNghiep',index:'ID_NgheNghiep', width:"50%", editable:true,align:'left',hidden:false,formatter: "select"},
...
function search_bn(){
 ...
 function _init(input,data,id) {
	...
	function resize_control(){
		...
		$("#rowed3").setGridHeight($(window).height()-240);
