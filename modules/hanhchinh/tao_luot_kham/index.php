...
<div>
        ...
        <input id="phanloai" kiemtra="trong"  type="text" name="phanloai" style="width:200px" tabindex="1" value="Nội soi TMH">
...
function create_bs(elem,datalocal){	
		...
		datastr:datalocal,
		datatype: "jsonstring" ,
		colNames:['Nickname', 'Họ và tên','Đang chờ',' Đang Khám','Xong','Tổng','Lịch làm việc','Lịch hẹn khám',''],
		colModel:[			
			...
			{name:'tong',index:'tong',hidden :false,width:'5%'},
...
function luu(){
	$('#thuchien').click(function(){
		if($("#phanloai_hidden").val()==''){
			...
			window.datatosend = '{';
			window.datatosend+='"phanloai":'+null;		
			window.datatosend+=',"goikham":'+null;
			window.datatosend+=',"doituong":'+null;
			window.datatosend+=',"bsyeucau":'+null;
			window.datatosend+=',"nguoichidinh":'+null;
			window.datatosend+=',"nguoilapphieu":'+null;
			window.datatosend+=',"nguoigioithieu":'+null;
			window.datatosend+=',"trangthai":'+null;
			window.datatosend+=',"pbvatly":'+null;
			window.datatosend+=',"hinhthuc":'+null;
			window.datatosend+=',"dhsinhton":'+null;
			window.datatosend+=',"comat":'+null;
			window.datatosend+=',"nhanthan":'+null;
			window.datatosend+=',"lamsang":'+null;
			window.datatosend+=',"id_thebhyt":'+null;
			window.datatosend+='}';
