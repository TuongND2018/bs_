 ...
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="left_col" style="width: 604px;">   
    	<div class="thongtin_luotkham_scroll " style="display:none"></div>
        	<span id="caption" style="font-size:17px;color:#09C;margin-left:5px;margin-top:5px; font-weight:bold">Điện não đồ</span>
            <br><br>
 ...
 <div id="panel_main">    
        ...
        <div class="ui-widget-content ui-layout-east" id="inner"> 
            ...
            <div class="ui-layout-center thongtin_thai"> 
                ...
                <textarea lang='luu'id="ketluan" name="ketluan" style="width:98%; height:92%;font-size:13px" ></textarea>
	...
	<div id="dialog-form" title="Thêm bản ghi" style="display:none;">
		...
		<div style="text-align: center;margin-top:10px">
			<input type="button" value="Yes" id="yes" class="ui-button ui-widget ui-state-default ui-corner-all fm-button-icon-left"style="width: 60px; margin-right: 20px;padding-left: 6px;"/> 
			<input type="button" value="No" id="no" class="ui-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="width: 60px;padding-left: 6px;"/> 
			<input type="button" value="Cancel" id="cancel"class="ui-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left: 20px; width: 60px;padding-left: 6px;"/>
		</div>
	</div>
...
$(document).ready(function() {	
	...
	if(id_kham2!="0"){
		$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_diennaodo2&idkham="+id_kham2+"&idbenhnhan="+id_benhnhan, 
			function( data ) {
				data_luotkham=data;
...
//alert(_id_trangthai); 
	...
	$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_diennaodo&idbenhnhan="+id_benhnhan,
		function( data ) {
			data_luotkham=data;
	 	//alertObject(data);
		var tam1_cls="";
	...
	$(function() {
		...
		$("#open_form_hentra").click(function(){
			alert(id_kham);
		});
        ...
        $("#yes2").click(function(){
			  ...
			  $("#dathuchien").click(function(){
                 			...
                 			_id_trangthai="DaThucHien";
						       ...
						       $.post('resource.php?module=<?=$modules?>&view=<?=$view?>&hienmaloi=1&action=controller&oper=dathuchien',dataToSend)
...
function create_DM_template_grid(elem, datalocal) {
        ...
        $(elem).jqGrid({
            datastr: datalocal,
            datatype: "jsonstring",
		colNames:['Tên Mẫu', 'Nội dung', 'Kết luận'],
		colModel:[			
