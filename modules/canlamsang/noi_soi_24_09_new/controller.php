...
function luuthuchien($store_name){
	...
	$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(trim($_POST['nguoithuchien']," "),0,($_POST["mota"]),($_POST["ketluan"]),($_POST["loikhuyen"]),trim($_POST["id_kham"]," "),($_POST["id_trangthai"]),trim($_POST['nguoisua']," "),trim($_POST['ngaygiosua']," "));
