...
$("#xemin").click(function(e){	
		$.cookie("in_status", "print_preview"); 
		dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=xray&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&chuky="+chuky,'SieuAmXRay');
		$(".frame_u78787878975f").css("width","793px");
	});
	/* $("#xemin").click(function(e){	
	$.cookie("in_status", "print_preview"); 	
