...
$data= new SQLServer;//tao lop ket noi SQL 
 ...
 $param3=NULL;
 $param4=NULL;
$store_name="{call GD2_LayDSXepHangCanLamSang(?,?,?,?)}";//tao bien khai bao store
...
$_store_name="{call GD2_LayDSXepHangCanLamSang(?,?,?,?)}";//tao bien khai bao store GD2_LayDSXepHangCanLamSang
//$params = array("ID_NhapKho",$start,$end,$sidx,$sord,"Gd2_PhieuNhap_2013","","*");//tao param cho store 
...
$param11=NULL;
 ...
 $param33=NULL;
 $param44=NULL;
$store_name11="{call GD2_LayDSXepHangCanLamSang(?,?,?,?)}";//tao bien khai bao store
