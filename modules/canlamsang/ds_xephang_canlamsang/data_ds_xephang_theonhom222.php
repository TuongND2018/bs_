...
$_store_name="{call GD2_LayDSXepHangCanLamSang_TheoNhomXepHang_New(?,?,?,?)}";//tao bien khai bao store GD2_LayDSXepHangCanLamSang
...
$param11=$_GET["id"];
 ...
 $param33=NULL;
 $param44=NULL;
$store_name1="{call GD2_LayDSXepHangCanLamSang_TheoNhomXepHang_New(?,?,?,?)}";//tao bien khai bao store
