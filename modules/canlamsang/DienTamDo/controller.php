...
function luudangkham($store_name){
	...
	//$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';			 
        	$bien2=  array(($_POST["id_kham"]),0,0,($_POST["ExtField1"]),($_POST["ketluan"]),($_SESSION["user"]["id_user"]),array($check1, SQLSRV_PARAM_OUT,SQLSRV_PHPTYPE_INT),0,$_POST["songayluukq"]);
...
function luuthuchien($store_name){
	...
	//$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';			 
        	$bien2=  array(($_POST["id_kham"]),($_POST["nguoithuchien"]),0,($_POST["ExtField1"]),($_POST["ketluan"]),($_SESSION["user"]["id_user"]),array($check1, SQLSRV_PARAM_OUT,SQLSRV_PHPTYPE_INT),($_SESSION["user"]["id_user"]),$_POST["songayluukq"]);
