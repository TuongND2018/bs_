...
switch ($_GET["oper"]) {
    case "dathuchien":
        dathuchien("GD2_Kham_Update_NguoiThucHien_Form_DienTamDo");
        break;
    case "luuthuchien":
...
function luudangkham($store_name){
	...
	//$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(($_POST["id_kham"]),0,0,($_POST["ExtField1"]),($_POST["ketluan"]),($_SESSION["user"]["id_user"]),array($check1, SQLSRV_PARAM_OUT,SQLSRV_PHPTYPE_INT),0);
...
function luuthuchien($store_name){
	...
	//$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(($_POST["id_kham"]),($_POST["nguoithuchien"]),0,($_POST["ExtField1"]),($_POST["ketluan"]),($_SESSION["user"]["id_user"]),array($check1, SQLSRV_PARAM_OUT,SQLSRV_PHPTYPE_INT),($_SESSION["user"]["id_user"]));
...
function luuhoantat($store_name){
	...
	//$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(($_POST["id_kham"]),($_POST["nguoithuchien"]),($_POST["chuandoan1"]),($_POST["ExtField1"]),($_POST["ketluan"]),($_SESSION["user"]["id_user"]),array($check1, SQLSRV_PARAM_OUT,SQLSRV_PHPTYPE_INT),($_SESSION["user"]["id_user"]));
