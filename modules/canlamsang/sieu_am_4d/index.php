...
<?php
    ...
    if($_SESSION["ThongTinBenhNhan"]["ID"]==""){
        ...
        echo "</script>";
		$data= new SQLServer;//tao lop ket noi SQL
        $params = array($_SESSION["ThongTinBenhNhan"]["ID"]);//tao param cho store
        $store_name="{call GD2_GetThongTinBenhNhan(?)}";//tao bien khai bao store
        $get_thongtinbenhnhan=$data->query( $store_name,$params);//Goi store
        $excute= new SQLServerResult($get_thongtinbenhnhan);//Ket noi lop xu ly SQL và truyen gia tri tra ve tu lop ket noi SQL
        $thongtinbenhnhan= $excute->get_as_array();//Tra ve mang toan bo data lay duoc
...
<body>
    ...
    <div class="top_form ui-widget-content">
        ...
        <a href="#" id="inlichKhamThai" class="fm-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;width:40px;  margin-bottom:1px;float: right; ">Lịch KT <span class="ui-icon ui-icon-print"></span></a>
        <a href="#" id="inPhieuGiamPhanTram" class="fm-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;width:50px;  margin-bottom:1px;float: right; ">Giảm %<span class="ui-icon ui-icon-print"></span></a>
        ...
        <span style="margin-left:12px;"><label  for="chonanh">Chọn ảnh</label><input id="chonanh" type="checkbox"></span>
        <span style="" id="In_CoChuKy" style="margin-left:5px" > 
        	In chữ ký <input type="checkbox" checked name="In_ChuKy" value="1"/>
        </span>
        ...
        <a href="#" id="inHinh4D" class="fm-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;  margin-bottom:1px;float: right; ">In 4D<span class="ui-icon ui-icon-print"></span></a>
        <a href="#" id="inPhieuGiam" class="fm-button ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;  margin-bottom:1px;float: right; ">Giảm<span class="ui-icon ui-icon-print"></span></a>
        </div>
        </div>
        ...
        <div class="ui-widget-content ui-layout-east" id="inner">
            <div class="ui-layout-north">
                ...
                <input style="width:15px;text-align:center;margin-top: 10px;" type="text" id="para4" name="para4" maxlength="1" >
                        <label style="width:30px;text-align:right">Giá: </label><input lang="luu"  style="width:40px" type="text" value="0" id="phithuchien" name="phithuchien" disabled>
...
var report_name=["Siêu âm 1 hình","Siêu âm 2 hình","Siêu âm 3 hình","Siêu âm 4 hình","Siêu âm 5 hình","Siêu âm 6 hình","Siêu âm 4 hình ngang","Siêu âm 3 hình ngang","Phiếu canh noãn","Phiếu giảm giá phần trăm siêu âm","Phiếu giảm giá siêu âm","Lich hẹn khám thai siêu âm","Xem in siêu âm thai 4d"];
    ...
    $("#xemin").click(function(e){
        ...
        if($("#soluongthai").val()=="2"){
			...
			{
            dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam4d_2",'<?=$modules?>');
			}else{
				dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam4d_2_khongchuky",'<?=$modules?>');
				}
        } else{
			if($('#In_CoChuKy input:checkbox').is( ":checked" ))
			{
            dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam4d",'<?=$modules?>');
			}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_khongchuky",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam4d_khongchuky",'<?=$modules?>');
			}
        }
    ...
    $("#kieu1").click(function(e){
        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu1Hinh",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",6,"sieuamkieu1",'<?=$modules?>');
    });
    $("#kieu2").click(function(e){
        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu2HinhNgang",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",6,"sieuamkieu2",'<?=$modules?>');
    });
    $("#kieu3").click(function(e){
        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu3Hinh",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",6,"sieuamkieu3",'<?=$modules?>');
    });
    $("#kieu4").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu4Hinh",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",7,"sieuamkieu4",'<?=$modules?>');
    });
    $("#kieu5").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu5Hinh",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",8,"sieuamkieu5",'<?=$modules?>');
    });
    $("#kieu6").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu6Hinh",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",9,"sieuamkieu6",'<?=$modules?>');
    });
    $("#kieu7").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu4HinhNgang",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",7,"sieuamkieu7",'<?=$modules?>');
    });
    /*$("#kieu8").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu2HinhNgang",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",7,"sieuamkieu8",'<?=$modules?>');
    });*/
    $("#kieu9").click(function(e){

        print_action="xemin";
        dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmThai4D_Kieu3HinhNgang",print_action,"PHIẾU SIÊU ÂM SẢN PHỤ KHOA 4 CHIỀU","4D 0B - GYN ULTRASOUND","BÁC SỸ SIÊU ÂM","left",7,"sieuamkieu9",'<?=$modules?>');
    });
    $("#inlichKhamThai").click(function(e){
        $("#luu").click();
        $.cookie("in_status", "print_preview");
        dialog_report("Xem trước khi in",90,90,"u78787878975a","resource.php?module=report&view=<?=$modules?>&action=lichhenkhamthai&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'SieuAmThai4D_LichHen');
        $(".frame_u78787878975a").css("width","793px");
        });
     $("#inPhieuGiamPhanTram").click(function(e){
        $("#luu").click();
        $.cookie("in_status", "print_preview");
        dialog_report("Xem trước khi in",90,90,"u78787878975b","resource.php?module=report&view=<?=$modules?>&action=phieumiengiam4d&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'PhieuGiamGiaSieuAmPhanTram');
        $(".frame_u78787878975b").css("width","793px");
        });
     $("#inPhieuCanhNoan").click(function(e){
        $("#luu").click();
        $.cookie("in_status", "print_preview");
        dialog_report("Xem trước khi in",90,90,"u78787878975c","resource.php?module=report&view=<?=$modules?>&action=phieucanhnoan&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'PhieuCanhNoan');
      ...
      $("#inPhieuGiam").click(function(e){
        ...
        if($("#phithuchien").val()<"250000"){
            ...
            $("#luu").click();
        $.cookie("in_status", "print_preview");
        dialog_report("Xem trước khi in",90,90,"u78787878975d","resource.php?module=report&view=<?=$modules?>&action=phieugiam4d&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'PhieuGiamGiaSieuAm');
   ...
   /* $('#luu').click(function ()
    {
       ...
       // dataToSend += phancach + '"songaythai":"' + _soNgayThai+ '"';
        ...
        $.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=edit&hienmaloi=3',dataToSend)
                     .done(function( gridData ) {
                                     //alert(gridData);
//                       tam=gridData.split(";");
//                       if($.trim(tam[1])=="0"){
...
$("#themvideo").click(function(){
    // $("#upload_input").click();
        ...
        _filetype="video/mpeg;video/mpg;video/mp4;video/avi";
         ...
         parent.postMessage('upload_module;resource.php?module=images_control&view=image_upload&id_form=61&multi=true&action_upload=upload_module&tenthumuc='+_tenthumuc+'&default_name='+_default_name+'&profile=tcd&filetype='+_filetype+";"+_default_name , '*')
