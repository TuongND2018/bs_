...
$(document).ready(function() {	
	...
	$("#xemin2").click(function(e){	
		$.cookie("in_status", "print_preview"); 
		dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=nhan_xray&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'nhan_xray');
		$(".frame_u78787878975f").css("width","793px");
	});
$("#xemin").click(function(e){	
		dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=ct_scanner&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&chuky="+chuky,'ct_scanner');
		$(".frame_u78787878975f").css("width","793px");
	});
	/* $("#xemin").click(function(e){	
	$.cookie("in_status", "print_preview"); 	
		...
		$(".frame_u78787878975f").css("width","793px");
		//dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=xray&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10",'SieuAmXRay');
	}); */

	if(id_kham2!="0"){
		
		$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_loaixray&idbenhnhan="+id_benhnhan, 
			function( data ) {
			data_luotkham=data;
