...
//print_r($_POST);
	...
	$params=  array($_POST["id_kham"],$_POST["nguoithuchien"],$_POST["lydongungdo"],$_POST["ketluan"],$_SESSION["user"]["id_user"]);
...
function luudangkham(){
	...
	$params=  array($_POST["id_kham"],$_POST["lydongungdo"],$_POST["ketluan"],$_SESSION["user"]["id_user"]);
...
function hoantat(){
	...
	$params=  array($_POST["id_kham"],$_POST["chuandoan1"],$_POST["lydongungdo"],$_POST["ketluan"],$_SESSION["user"]["id_user"]);
...
print_r($_POST);
	...
	$params=  array($_POST["id_kham"],$_POST["nguoithuchien"],$_POST["chuandoan1"],$_POST["lydongungdo"],$_POST["ketluan"],$_SESSION["user"]["id_user"]);
