...
$(document).ready(function() {	
	...
	resize_control();
		...
		{
			print_action="xemin";
			dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=EEG&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&tieude=PHIẾU ĐIỆN NÃO ĐỒ ĐIỆN TOÁN&chucnang=ENCEPHALO - ELECTROGRAPHY&chucdanh=BÁC SỸ CHẨN ĐOÁN&chucdanh2=KỸ THUẬT VIÊN",'EEG');
			
		}
		else
		{
			print_action="xemin";
			dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=EEG_InNgang&header=left&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&tieude=PHIẾU ĐIỆN NÃO ĐỒ ĐIỆN TOÁN&chucnang=ENCEPHALO - ELECTROGRAPHY&chucdanh=BÁC SỸ CHẨN ĐOÁN&chucdanh2=KỸ THUẬT VIÊN",'EEG_InNgang');	
		}
	});
	...
	$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_diennao2&idbenhnhan="+id_benhnhan+"&idkham="+id_kham, 
		function( data ) {
			data_luotkham=data;
	 	//alert(data);
		var tam1_cls="";
...
function resize_control(){
	...
	//#thongsokt").css("height",$(".ui-layout-east").height()-$(".ui-layout-south").height()-47+"px");
