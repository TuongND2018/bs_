 ...
 <div id="panel_main">    
        ...
        <div class="ui-widget-content ui-layout-east" id="inner"> 
            ...
            <div class="ui-layout-center thongtin_thai"> 
            	...
            	<input id="combo_loikhuyen" name="combo_loikhuyen"  lang='luu' type="text" style="width:234px;height: 16px!important; font-size:13px" placeholder="--Chọn mẫu--" >
                        <input id="combo_loikhuyen1"   name="combo_loikhuyen1" type="text"  style="display:none" >
...
$(document).ready(function() {	 
	...
	create_combobox('#template_title', '#template_title1', ".data_template_title", "#data_template_title", create_DM_template_grid, 500, 400, 'chọn mẫu', 'data_lochanlong',0);
	
	create_combobox('#template_title2', '#template_title21', ".data_template_title2", "#data_template_title2", create_DM_chatbanhon, 500, 400, 'chọn mẫu', 'data_chatbanhon',0);
	
	create_combobox('#template_title3', '#template_title31', ".data_template_title3", "#data_template_title3", create_DM_nepnhan, 500, 400, 'chọn mẫu', 'data_nepnhan',0);
	
	create_combobox('#template_title4', '#template_title41', ".data_template_title4", "#data_template_title4", create_DM_sactoda, 500, 400, 'chọn mẫu', 'data_sactoda',0);
	
	create_combobox('#combo_loikhuyen', '#combo_loikhuyen1', ".data_combo_loikhuyen", "#data_combo_loikhuyen", create_loikhuyen, 500, 400, 'chọn mẫu', 'data_loikhuyen',0);
...
function create_loikhuyen(elem, datalocal) {
        datalocal = jQuery.parseJSON(datalocal);
        $(elem).jqGrid({
            datastr: datalocal,
            datatype: "jsonstring",
            ...
            colModel: [
                 {name: 'Ten', index: 'Ten', hidden: false,width:"30%"},
                {name: 'NoiDung', index: 'NoiDung', hidden: false,width:"70%"},
