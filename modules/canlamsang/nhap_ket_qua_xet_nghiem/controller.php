       ...
       foreach ($_POST['data'] as $key => $value) {
        ...
        if(preg_match("/\,/",$value["ketqua"])){
          $value["ketqua"]= str_ireplace(",",".",$value["ketqua"]);     
            ...
            $params1=array(($value["ID_Kham"]),($value["ID_BenhNhan"]),($value["ID_XetNghiem"]),($value["ketqua"]),0);
            //print_r($params1);
            $store_name1="{call GD2_ketquaxetnghiem_insert (?,?,?,?,?)}";
            //print_r($params1);
...
function updatecannamnu(){ 
        ...
        if(trim($value["CanNu4"]," ")==""){    
            $value["CanNu4"]=null;
                ...
                $params1=array(($value["CanNam1"]),($value["CanNam2"]),($value["CanNam3"]),($value["CanNam4"]),($value["CanNu1"]),($value["CanNu2"]),($value["CanNu3"]),($value["CanNu4"]),($value["Red"]),($value["Blue"]),($value["Yellow"]),($value["GiaTriBinhThuong1"]),($value["ID_XetNghiem"]));
                //print_r($params1);
