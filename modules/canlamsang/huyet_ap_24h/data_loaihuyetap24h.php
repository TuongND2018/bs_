...
$params = array('huyet_ap_24h',$_GET["idbenhnhan"]);//tao param cho store 
$store_name="{call GD2_KhamGetDataByTenFormAndIDBenhNhan(?,?)}";//tao bien khai bao store
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
	...
	if($row["ID_NguoiSua"]!='')
            $row["ID_NguoiSua"]=$row["ID_NguoiSua"];
    else $row["ID_NguoiSua"]='';
