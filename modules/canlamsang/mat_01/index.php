...
var report_code=["mat_01"];
var report_name=["mat_01"];
var _id_luotkham=[];
var _id_loaikham=[];
...
$("#xemin").click(function(e){	
			if(_id_trangthai=="DangKham"|| _id_trangthai=="DangCho"){
			       ...
			       if(window.kiemtra2=="dathuchien1"){
		...
		{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"mat_01",print_action,"","","","left",3,"mat_01",'<?=$modules?>');
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"mat_01",print_action,"","","","left",3,"mat_01_khongchuky",'<?=$modules?>');
			}
...
//===========================================
	...
	if(id_kham2!="0"){
		...
		$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_loaimat&idbenhnhan="+id_benhnhan, 
			function( data ) {
			data_luotkham=data;
...
function resize_control(){
	...
	$("#ketluan").css("height",$(".ui-layout-east").height()-$(".ui-layout-south").height()-53+"px");
