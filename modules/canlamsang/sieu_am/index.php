...
<body>
 ...
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="right_col">
        ...
        <a href="#" id="xemin2" class=" ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px; width:65px; margin-bottom:1px;float: right; ">In thêm<span class="ui-icon ui-icon-print"></span></a>
...
$(document).ready(function() {	 
	...
	$("#xemin").click(function(e){	
		...
		{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"PHIẾU SIÊU ÂM DOPPLER MÀU TỔNG QUÁT","GENERAL ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam",'<?=$modules?>',"780");	
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"PHIẾU SIÊU ÂM DOPPLER MÀU TỔNG QUÁT","GENERAL ULTRASOUND","BÁC SỸ SIÊU ÂM","left",3,"sieuam_khongchuky",'<?=$modules?>',"780");		
			}
	...
	$("#xemin2").click(function(e){	
		...
		if($('#chonanh').is( ":checked" )) {
			...
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"PHIẾU SIÊU ÂM DOPPLER MÀU TỔNG QUÁT","GENERAL ULTRASOUND","BÁC SỸ SIÊU ÂM","left",4,"sieuaminthem",'<?=$modules?>',"780");		
