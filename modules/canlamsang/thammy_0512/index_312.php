...
$(document).ready(function() {	 
	...
	$("#xemin").click(function(e){	
		...
		{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"KẾT QUẢ PHÂN TÍCH DA","SKIN ANALYSIS","BÁC SỸ TƯ VẤN","left",3,"thammy",'<?=$modules?>',"780");	
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"sieuam",print_action,"KẾT QUẢ PHÂN TÍCH DA","SKIN ANALYSIS","BÁC SỸ TƯ VẤN","left",3,"thammy",'<?=$modules?>',"780");		
			}
