...
switch ($_GET["oper"]) {
    case "dathuchien":
        dathuchien("GD2_Kham_dathuchien_thammy");
        break;
    case "luuthuchien":
        luuthuchien("GD2_Kham_Update_thammy");
        break;
    case "hoantat":
        hoantat("GD2_Kham_hoantat_thammy");
        break;
     case "luuhoantat":
        luuhoantat("GD2_Kham_Update_thammy");
        break;
     case "luudangkham":
        luudangkham("GD2_Kham_Update_thammy");
        break;    
}	 		 
