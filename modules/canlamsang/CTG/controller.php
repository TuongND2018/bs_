...
//            );
        $bien2=  array(($_POST["nguoithuchien"]),($_POST["mota"]),($_POST["ketluan"]),null,($_POST["id_kham"]),($_POST["id_trangthai"]),($_POST["giothuchien"]));
...
function luudangkham($store_name){
	...
	$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(0,0,($_POST["mota"]),($_POST["ketluan"]),null,($_POST["id_kham"]),($_POST["id_trangthai"]),0,0);
...
function luuthuchien($store_name){
	...
	$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(trim($_POST['nguoithuchien']," "),0,($_POST["mota"]),($_POST["ketluan"]),null,($_POST["id_kham"]),($_POST["id_trangthai"]),trim($_POST['nguoisua']," "),trim($_POST['ngaygiosua']," "));
...
function hoantat($store_name){
	...
	print_r($_POST);
        ...
        $bien2=  array($_POST['nguoithuchien'],($_POST["chuandoan1"]),($_POST["mota"]),($_POST["ketluan"]),null,($_POST["id_kham"]),($_POST["id_trangthai"]),($_POST["giohoantat"]));
...
function luuhoantat($store_name){
	...
	$chuoi.=",?)";
        ...
        $chuoi2='(?,?,?,?,?,?,?,?,?)';
        	...
        	$bien2=  array(trim($_POST['nguoithuchien']," "),trim($_POST['chuandoan1']," "),($_POST["mota"]),($_POST["ketluan"]),null,($_POST["id_kham"]),($_POST["id_trangthai"]),trim($_POST['nguoisua']," "),trim($_POST['ngaygiosua']," "));
