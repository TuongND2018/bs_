...
<body>
 ...
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="left_col" style="width: 50%;">   
...
$(document).ready(function() {	 
	...
	$("#xemin").click(function(e){	
		...
		dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=ctg&header=left&id_benhnhan="+id_benhnhan+"&id_luotkham="+_id_luotkham2+"&type=report&id_form=10&id_kham="+_kham+"&chuky="+chuky,'xetnghiem');
...
function navigator_load(_value,_click){
	...
	$.each( data_luotkham, function( key, val ) {		
		...
		//$(".thongtin_luotkham_scroll").html("sd");	
	});
	loaikham_click();
	if(_click=="first"){
...
function resize_control(){
	...
	//$("#center_col").css("width",$(window).width()/2-10+"px");
	...
	$("#ketluan").css("height",$(".ui-layout-east").height()-$(".ui-layout-south").height()-40+"px");
