 ...
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_chidinh" style="width:687px!important">
 		<div class="form_row">
			...
			<label style="width:90px;text-align:right">Ngày chỉ định:</label><input id="ngaychidinh"; name="ngaychidinh"lang='luu'style="width:100px" type="text" id="ngaychidinh" disabled>
...
$(document).ready(function() {	
	...
	$("#luu").click();	
		...
		{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmEndo",print_action,maviettat,"VIDEO GASTRO - DOUDENAL SCOPY","BÁC SỸ NỘI SOI","left",3,"noisoi",'<?=$modules?>');	
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"SieuAmEndo",print_action,maviettat,"VIDEO GASTRO - DOUDENAL SCOPY","BÁC SỸ NỘI SOI","left",3,"noisoi_khongchuky",'<?=$modules?>');
		}
				...
				for(i=0;i<val.length;i++){
					...
					//alertObject(val[i]);
                       ...
                       if(para!=null){
							...
							if(window.n_id_loaikham==15 || window.n_id_loaikham==6228 || window.n_id_loaikham==6229 ||  window.n_id_loaikham==6233 ||  window.n_id_loaikham==6234 ||  window.n_id_loaikham==6235 ||  window.n_id_loaikham==6236 ||  window.n_id_loaikham==6237){
								window.pilogy="1";
								$(".ui-layout-north").show();
...
$( "#para1" ).keyup(function(e) {
    ...
    function luu_pilogy(){
    	if(pilogy=="1"){
    		$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=luu_pilogy&id_kham='+id_kham+'&pilogy='+$("#combobox").val())
			                        .done(function( gridData ) {	
			                                             tooltip_message("Đã hoàn tất");	 
			                                            })
			                                            .fail(function() {
