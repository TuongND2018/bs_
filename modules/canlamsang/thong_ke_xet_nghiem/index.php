...
<body>
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_chidinh" style="height: 63px;width:687px!important">
 		<div class="form_row">
        	<label style="width:90px;text-align:right">Người chỉ định:</label><input lang='luu' name="nguoi_chidinh"style="width:100px" type="text" value="Bs Minh TQ">
			...
			<label style="width:90px;text-align:right">Ngày chỉ định:</label><input name="ngaychidinh"lang='luu'style="width:100px" type="text" value="22:26 24/05/13">
 ...
 <div id="panel_main">    
        ...
        <div class="ui-widget-content ui-layout-east" id="inner"> 
            <div class="ui-layout-north thongtin_thai" >
            	...
            	<input style="width:15px;text-align:center;" type="text" id="para4" name="para4" maxlength="1" > 
            ...
            <div class="ui-layout-center thongtin_thai"> 
                ...
                <textarea lang='luu'id="ketluan" name="ketluan"style="width:98%; height:87%;font-size:13px" ></textarea>
            ...
            <div class="ui-layout-south thongtin_thai">
                ...
                <textarea id="loikhuyen"name="loikhuyen" lang='luu'style="width:98%; height:70%;font-size:13px" ></textarea>
            </div>
