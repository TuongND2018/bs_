...
$(document).ready(function(e) {
	...
	if(tam=='dongdialog'){
		...
		$("#rowed3").jqGrid('setGridParam',{datatype: 'json',url:"resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_danhsach_phieulinhthuoc&idkhoa=<?=$_GET['idkhoa']?>&tungay="+$("#tungay").val()+"&denngay="+$("#denngay").val()}).trigger('reloadGrid');
	}
	...
	$("#xem").click(function(e) {
        $("#rowed3").jqGrid('setGridParam',{datatype: 'json',url:"resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_danhsach_phieulinhthuoc&tungay="+$("#tungay").val()+"&denngay="+$("#denngay").val()}).trigger('reloadGrid');
    });
...
function create_grid() {
        $("#rowed3").jqGrid({
             url: 'resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_danhsach_phieulinhthuoc&idkhoa=<?=$_GET['idkhoa']?>&tungay='+$('#tungay').val()+'&denngay='+$('#denngay').val(),
   			datatype: "json",
        ...
        $("#rowed4").jqGrid({
           ...
           loadonce: true,
            ...
            onSelectRow: function(id) {
				...
				$("#rowed5").jqGrid('setGridParam',{datatype: 'json',url:"resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_chitietthuocbyid_donthuoc&idphieulinhthuoc="+id}).trigger('reloadGrid');
            },
            ondblClickRow: function(rowId, rowIndex, columnIndex) {
...
function sua(){
	...
	links='resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=formsua&type=test&id_form=<?=$_GET["id_form"]?>&tenkhoa=<?=$_GET["tenkhoa"]?>&idkhoa=<?=$_GET["idkhoa"]?>&idphieulinh='+window.idphieulinh+'&ac=edit';
