...
<input type="hidden" id="text_para4" value=""/>
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="right_col" style="width: 680px!important">
    	...
    	<a href="#" id="dong" class=" ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="width:64px;float: right; display:none">Đóng<span class="ui-icon ui-icon-trash"></span></a> 
...
$(document).ready(function() {	
	...
	dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=khamthai&header=top&id_benhnhan="+id_benhnhan+"&id_kham="+id_kham+"&type=report&id_form=10&chuky="+chuky,'PhieuKhamThai');
