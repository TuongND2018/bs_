 ...
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="right_col" style="width: 680px!important">
    	...
    	<div style="margin-top: 12px;">
		  <a href="#" id="lichkhamthai" class="ui-widget ui-state-default ui-corner-all ui-button-icon-left" style="float: right; position: absolute; margin-left: 291px; width: 100px; height: 22px; padding-left:30px; text-decoration:none; padding-top: 5px;">Lịch khám thai<span class="ui-icon ui-icon-clock" style="margin-left: -29px; margin-top: -17px;"></span></a> 
...
$(document).ready(function() {	
    ...
    $.post( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_para&idbenhnhan="+id_benhnhan).done(function(data) {
		...
		$("#left_col div div").click(function(e) {
				...
				for(var i=0;i<val.length;i++){
					...
					if(tam==tam1){	
						...
						$.get( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_sieuamthai4d&idbenhnhan="+id_benhnhan+"&idluotkham="+_id_luotkham2).done(function(data) {
						 if(data==0){
