<?php
//$_SESSION["ThongTinBenhNhan"]["ID"]=43283;
...
<input type="hidden" id="text_para4" value=""/>
 <div class="top_form ui-widget-content" >
    ...
    <div class="thongtin_luotkham" id="right_col" style="width: 680px!important">
    	...
    	<a href="#" id="luu" class=" ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px; margin-top: 1px;;width:64px;  margin-bottom:1px;float: right; ">Lưu<span class="ui-icon ui-icon-disk"></span></a> 
    	<a href="#" id="sua" class=" ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px; margin-top: 1px;width:64px;  margin-bottom:1px;float: right; ">Sửa<span class="ui-icon ui-icon-pencil"></span></a>
    	<a href="#" id="boqua" class=" ui-widget ui-state-default ui-corner-all fm-button-icon-left" style="margin-left:0px;width:64px;  margin-bottom:1px;float: right;margin-top: 1px;">Bỏ qua<span class="ui-icon ui-icon-close"></span></a>
        
       
    		 	
    	</div>
    	<div style="margin-top: 12px;">
		  <a href="#" id="lichkhamthai" class="ui-widget ui-state-default ui-corner-all ui-button-icon-left" style="float: right; position: absolute; margin-left: 291px; width: 88px; height: 22px; padding-left:30px; text-decoration:none; padding-top: 5px;">Lịch khám thai<span class="ui-icon ui-icon-clock" style="margin-left: -29px; margin-top: -17px;"></span></a> 
    	...
    	<div style="margin-top: -9px">
	    	<label><a id="hentrakq" href="#">Giờ hẹn trả kết quả:</a></label>
 ...
 <div id="panel_main" >    
             ...
             <div class="ui-widget-content ui-layout-west"  id="right_col1">
                      ...
                      <fieldset id="tinhtuoithai_fieldset">
                        ...
                        <table width="100%">
                                    <tr>
                                      ...
                                      Là lần đầu tiên khám thai</span></td>
                                    </tr>
                                    <tr>
                                      <td style="width: 80px;">Tuổi thai K.thai:</td>
                    ...
                    Tuần
                      <input class="textnho xanhnhat" type="text" name="SA_SoNgayThai" lang="luu" id="SA_SoNgayThai" /></td>
                                    ...
                                    <tr>
                                    <td>NSDK (K.thai):</td>
                                      <td><input class="textngay xanhnhat" type="text" name="NSDK_KhamThai" lang="luu" id="NSDK_KhamThai" /></td>
                                      <td>NSDK (siêu âm):</td>
  ...
  <fieldset id="dauhieubatthuongthainghen_fieldset">
    ...
    <label style="font-weight:bold">Các dấu hiệu bất thường khác </label><br>
...
<div id="panel_main2">    
        ...
        <div class="ui-widget-content ui-layout-west"  id="inner">
				<div class="ui-layout-north thongtin_thai" id="sub_inner"> 
                    ...
                    <div class="ui-layout-north thongtin_thai"> 
                        ...
                        <span class="custom-combobox">
                   		<input id="combo_khamnoikhoa" name="combo_khamnoikhoa"  type="text" style="width:268px;" placeholder="--Chọn mẫu--">
                        </span> 
                  ...
                  <div class="ui-layout-center thongtin_thai"> 
                        <label style="text-align:left;" class="chumauxanh">Khám phụ khoa:</label>
                         <span class="custom-combobox">
                   		<input id="combo_khamphukhoa" name="combo_khamphukhoa"  type="text" style="width:264px;" placeholder="--Chọn mẫu--">
                        </span> 
              ...
              <div class="ui-layout-center thongtin_thai" id="sub_inner2"> 
                   <div class="ui-layout-north thongtin_thai" id="nonemagintop"> 
                        ...
                        <span class="custom-combobox">
                   			<input id="combo_khamvu" name="combo_khamvu"  type="text" style="width:301px;" placeholder="--Chọn mẫu--">
                        </span> 
                  ...
                  <div class="ui-layout-center thongtin_thai"> 
                        ...
                        <span class="custom-combobox">
                   			<input id="combo_khamkhac" name="combo_khamkhac"  type="text" style="width:290px;" placeholder="--Chọn mẫu--">
                        </span> 
        ...
        <div class="ui-widget-content  thongtin_thai ui-layout-center " id="n_center">
           <div id="sub_center">
           	<fieldset id="sub_center_fieldset" style="padding:5px !important;">
                ...
                <input type="checkbox" onClick=" return checkboxval(this.id);"  name="ktt_binhthuong" lang='luu' id="ktt_binhthuong"> Bình thường
                <input type="checkbox" onClick=" return checkboxval(this.id);"  name="ktt_phutoanthan" lang='luu' id="ktt_phutoanthan"> Phù toàn chân
                <input type="checkbox" onClick=" return checkboxval(this.id);"  name="ktt_phu2chiduoi" lang='luu' id="ktt_phu2chiduoi"> Phù 2 chi dưới
                <input type="checkbox" onClick=" return checkboxval(this.id);"  name="ktt_daxanhdiemmacnhot" lang='luu' id="ktt_daxanhdiemmacnhot"> Da xanh, diêm mạc nhợt
            </fieldset>
            <label style="text-align:left;margin-top:10px;margin-bottom:10px;" class="chumauxanh">Khám sản khoa:</label>
             <span class="custom-combobox" style="margin-top:10px">
                 <input id="combo_khamsankhoa" name="combo_khamsankhoa"  type="text" style="width:318px;" placeholder="--Chọn mẫu--">
              </span> 
        ...
        <div class="ui-widget-content ui-layout-east" id="inner2"> 
            <div class="ui-layout-north thongtin_thai"id="sub_inner2"> 
                ...
                <span class="custom-combobox">
                 <input id="combo_ketluan" name="combo_ketluan"  type="text" style="width:278px;" placeholder="--Chọn mẫu--">
              	</span> 
          ...
          <div class="ui-layout-center thongtin_thai" id="sub_inner22"> 
            	<label style="text-align:left;font-size:14px;color:#F08080; font-weight:bold;">ĐỀ NGHỊ:</label>
                 <span class="custom-combobox">
                 <input id="combo_denghi" name="combo_denghi"  type="text" style="width:287px;" placeholder="--Chọn mẫu--">
              	</span> 
...
$(document).ready(function() {	
	...
	$.get( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_solankhamthai&idbenhnhan="+<?=$_SESSION["ThongTinBenhNhan"]["ID"]?>, function( data ) {
	  //$( ".result" ).html( data );
	  window.solandakhamthai=data;
	  //alert(data);
	});
	
	$.get( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_sieuamthai4d&idbenhnhan="+<?=$_SESSION["ThongTinBenhNhan"]["ID"]?>).done(function(data) {
	...
	$('#NgayKinhCuoi').datepicker( {
     onSelect: function (dateText, inst) {
		 ...
		 var date = new Date(rs[1]+"/"+rs[0]+"/20"+rs[2]);
		 var date2 = new Date(rs[1]+"/"+rs[0]+"/20"+rs[2]);
		 var date3 = rs[1]+"/"+(rs[0]-1)+"/20"+rs[2];
			...
			if(today_date2 < date){
				...
				var MyDate2 = new Date(rs[1]+"/"+rs[0]+"/20"+rs[2]);
				...
				//alert(MyDateString+"-"+toTimestamp('01/15/2014'));
...
$("#add_khamnoikhoa,#add_khamphukhoa,#add_khamvu,#add_khamsankhoa,#add_khamkhac,#add_ketluan,#add_denghi").click(function(e){
	...
	$.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_loaikham_thai&idbenhnhan="+<?=$_SESSION["ThongTinBenhNhan"]["ID"]?>, 
		function( data ) {
			data_luotkham=data;
	 	//alertObject(data);
		var tam1_cls="";
				...
				for(var i=0;i<val.length;i++){
					...
					if(tam==tam1){	
						...
						$("#hentrakq").click(function(e){
							links='resource.php?module=canlamsang&view=ds_xephang_canlamsang&action=ds_hentraKQ3&type=test&id_form=123&idluotkham='+_id_luotkham2;
							elem=1 + Math.floor(Math.random() * 1000000000); 
							width=90;
							height=80;   
							dialog_add_dm("",width,height,elem,links); 
...
function load_image(search_string){	   
	  ...
	  //alert(_folder_name);
	  $("#images_viewer").attr("src","resource.php?module=images_control&view=non_dicom_viewer&id_form=57&tenthumuc="+_folder_name+"&search_string="+search_string);   
...
function luu_post(){
	...
	$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=luudangkham',datalocalToSend)
	...
	$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=luuthuchien',datalocalToSend)
		 .done(function( gridData ) {	
			delete window.datalocalToSend;
				reloadform(); 
				tooltip_message("Đã lưu");
	 ...
	 if(window.oper=="hoantat1"){
		$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=luuhoantat',datalocalToSend)
				 .done(function( gridData ) {	
						delete window.datalocalToSend;
						 reloadform(); 
						 tooltip_message("Đã lưu");
...
function hoantat_post(){
	...
	$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=hoantat',datalocalToSend)
	.done(function( gridData ) {	
		delete window.datalocalToSend;
		 reloadform(); 
	 	tooltip_message("Đã lưu");
...
$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=controller&oper=dathuchien',datalocalToSend)
.done(function( gridData ) {
	delete window.datalocalToSend;	
	reloadform(); 
	tooltip_message("Đã lưu");
