...
$data= new SQLServer;//tao lop ket noi SQL 
 ...
 $param1=$_GET["id"];
//echo $param1;
$store_name="{call GD2_Kham_SelectByID_luotKham_CD_DieuTriPhoiHop(?)}";//tao bien khai bao store
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
  ...
  //  $responce->rows[$i]['id']=$row["idloaikham"];
    $responce->rows[$i]['cell']=array($row["idloaikham"],"", $row["idloaikham"], $slmoingay, $phidukien, $songay, $phithuchien, $idtrangthai, $thuchien, $bschidinh,"","","","", $row["ID_Kham"],"","","","","",1, $IDNhomCLS, $row["NgayGioTao"],$phithuchientheonhom,$Id_phy_dtph,$lanchidinh);
    $i++; 
}
