...
var loadlandau=0;
    ...
    create_combobox('#com_thuochmk','#com_thuochmk1',".data_thuochmk","#data_thuochmk",create_ds_pbChuyenMon,500,300,'Danh mục ','data_pbchuyenmon',window.default_id_pb_ChuyenMon);
        ...
        var timer1;
			...
			//$("#panel_main").css({ 'opacity':''});
         window.duongdandata='resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_xephang';
...
$("#benhanC").click(function(e){
 ...
 $("#DShuyxephang").click(function()

        {
          ...
          $.post('resource.php?module=web_services&function=get_link&action=index&folder=ds_huy_xephang:').done(function(data) {
       elem=1 + Math.floor(Math.random() * 1000000000);
        width=90;
        height=90;
       var folder= data.split(';');
       var links='resource.php?module='+folder[0]+'&view='+folder[1]+'&id_form='+folder[2];
          dialog_main("Ds hủy xếp hàng " + ' nhân viên', 100, 100, elem,links);
...
function create_dsTang(elem,datalocal){
 datalocal=jQuery.parseJSON(datalocal);
  ...
  $("#rowed3").jqGrid('setGridParam',{url:'resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_ds_xephang_dangcho&id_tang='+ selr}).trigger('reloadGrid');
    ...
    $("#rowed3").jqGrid({
        ...
        datatype: "jsonstring",
            colNames: ['LuotKham', '<?php get_text1("maBN") ?>', '<?php get_text1("hoten") ?>',
                ...
                'Yêu cầu', 'BS trước', 'G.chú', 'N.Dung TK', 'Trạng thái', 'Sansang', 'NotesStatus', 'ID_BenhNhan','ID_PhongKhamVatLy'],
            colModel: [
                ...
                {name: 'TenBenhNhan', formatter: kiemtra_dk_id_trangthai, index: 'TenBenhNhan', search: false, width: "30%", editable: false, align: 'left', hidden: false},
                {name: 'Tuoi', index: 'Tuoi', search: false, width: "4%", editable: false, align: 'left', hidden: false},
                {name: 'GioiTinh', index: 'GioiTinh', search: false, width: "6%", editable: false, align: 'left', hidden: false},
                {name: 'TenPhanLoaiKham', index: 'TenPhanLoaiKham', search: false, width: "15%", editable: false, align: 'left', hidden: false},
                {name: 'TenLoaiKham', index: 'TenLoaiKham', search: false, width: "15%", editable: false, align: 'left', hidden: false},
                {name: 'LoaiDoiTuongKham', index: 'LoaiDoiTuongKham', search: false, width: "10%", editable: false, align: 'left', hidden: false},

                {name: 'GioHenKham', index: 'GioHenKham', search: false, width: "10%", editable: false, align: 'left', hidden: false},
                {name: 'ThoiGianVaoKham', formatter: kiemtra_dk_tg, index: 'ThoiGianVaoKham', search: false, width: "10%", editable: false, align: 'center', hidden: false, edittype: "text", editoptions: {
                ...
                {name: 'BSTruoc', index: 'BSTruoc', search: false, width: "10%", editable: false, align: 'left', hidden: false},
                {name: 'GhiChu', index: 'GhiChu', width: "5%", search: false, editable: false, align: 'left', hidden: false},
                {name: 'NoiDungTaiKham', index: 'NoiDungTaiKham', search: false, width: "10%", editable: false, align: 'left', hidden: false},
    ...
    $("#rowed4").jqGrid({
        ...
        datatype: "jsonstring",
            colNames: ['LuotKham', '<?php get_text1("maBN") ?>', '<?php get_text1("hoten") ?>', '<?php get_text1("tuoi") ?>',
                ...
                '<?php get_text("BsKham") ?>', 'Ghi chú', 'HoanTatHoSo', 'Trạng thái', 'Sẵn sàng', 'NotesStatus', 'ID_BenhNhan'],
            colModel: [
                ...
                {name: 'NgayGioHenTraKQ',sorttype:"date",sortable: true,formatter:'date',formatoptions: {srcformat: 'd/m/Y H:i', newformat: 'H:i d/m/Y'}, index: 'NgayGioHenTraKQ', search: false, width: "2%", editable: true, align: 'center', hidden: false, edittype: "text", cellattr: tomaugiohen,
                },
                ...
                {name: 'HoanTatHoSo', index: 'HoanTatHoSo', search: false, width: "0%", editable: false, align: 'left', hidden: true},
                {name: 'TrangThaiHoSo', index: 'TrangThaiHoSo', search: false, width: "2%", editable: false, align: 'left', hidden: false},
                {name: 'SanSangGoiVaoKham', index: 'SanSangGoiVaoKham', search: false, width: "1%", editable: false, align: 'left', hidden: false, edittype: "checkbox", formatter: "checkbox", editoptions: {value: "1:0"}},
...
;
    ...
    'Ghi Chú', 'NotesStatus', 'ID_BenhNhan','TrảKQ'],
            colModel: [
                {name: 'ID_LuotKham', index: 'ID_LuotKham', search: false, width: "0%", editable: false, align: 'left', hidden: true},
                {name: 'MaBenhNhan', index: 'MaBenhNhan', search: false, width: "10%", editable: false, align: 'left', hidden: false},
                {name: 'TenBenhNhan', index: 'TenBenhNhan', search: false, width: "20%", editable: false, align: 'left', hidden: false},
                {name: 'Tuoi', index: 'Tuoi', search: false, width: "10%", editable: false, align: 'left', hidden: false},

                {name: 'TenPhanLoaiKham', index: 'TenPhanLoaiKham', search: false, width: "20%", editable: false, align: 'left', hidden: false},

                {name: 'Bslamsang', index: 'Bslamsang', search: true, width: "10%", editable: false, align: 'left', hidden: false},

                //   {name: 'tentuoigioi', index: 'tentuoigioi', search: false, width: "2%", editable: false, align: 'left', hidden: false }
                {name: 'GhiChu', index: 'GhiChu', search: false, width: "10%", editable: false, align: 'left', hidden: false},
                {name: 'NotesStatus', index: 'NotesStatus', search: false, width: "0%", editable: false, align: 'left', hidden: true},
                {name: 'ID_BenhNhan', index: 'ID_BenhNhan', search: false, width: "0%", editable: false, align: 'left', hidden: true},
...
//vangmat
    ...
    $("#datraKQ").click(function(e) {
        ...
        $.post('resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller&oper=update_datraKQ&mabenhnhan=' + mabenhnhan + '&id_luotkham=' + iD_LuotKham + '&datraKQ=' + datKQ).done(function(data)
        {
            if ($.trim(data) == '') {
                tooltip_message("<?php get_text1("sua_thanhcong") ?>");
...
//alert('dss');
        ...
        $.post('resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller&oper=update_chuasansang&id_luotkham=' + iD_LuotKham + '&sanSangGoiVaoKham=' + sanSangGoiVaoKham).done(function(data)
        {
            if ($.trim(data) == '') {
                tooltip_message("<?php get_text1("sua_thanhcong") ?>");
    ...
    $("#xonghoso").bind("click", function(e) {
        ...
        $.post('resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller&oper=update_hoanTatHoSo&id_luotkham=' + iD_LuotKham + '&hoanTatHoSo=' + hoanTatHoSo).done(function(data)
        {
            if ($.trim(data) == '') {
                tooltip_message("<?php get_text1("sua_thanhcong") ?>");
...
//alert('alert(idbenhnhan);');
    ...
    $("#thongtinluotkhamC").click(function(e){
     ...
     $( "#xemtatca" ).click(function() {
		...
		//	document.getElementById("thuochangmuckham").checked=false;
			//$("#rowed3").jqGrid('setGridParam',{url:'resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_ds_xephang_dangcho&id_tang='}).trigger('reloadGrid');
