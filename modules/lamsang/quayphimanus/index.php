...
<table width="100%">
  ...
  <tr>
    <td class="td1">Khám hậu môn trực tràng</td>
    <td colspan="2" ><input id="combo_soitructrang1"  name="combo_soitructrang1" type="text" lang='luu' style="display:none" >
      <textarea name="dacdiemhaumon" id="dacdiemhaumon"  lang='luu'></textarea></td>
  </tr>
  <tr>
    <td class="td1">Kết quả quay phim</td>
    <td colspan="2" >
    <span class="custom-combobox">
  ...
  <tr>
    ...
    <td style="padding-left: 61px;"><input type="text" name="text_chuandoan"  lang='luu' id="text_chuandoan" /></td>
  </tr>
  <tr>
    <td>PP điều trị 1:</td>
...
$(document).ready(function() {
	...
	$.cookie("in_status", "print_preview"); 	
		...
		if($('#In_CoChuKy input:checkbox').is( ":checked" )){
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"quayphim_anus",print_action,"PHIẾU QUAY PHIM HẬU MÔN - TRỰC TRÀNG","VIDEO-PROCTOSCOPY","BÁC SỸ CHẨN ĐOÁN","left",3,"quayphim_anus",'<?=$modules?>');
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"quayphim_anus",print_action,"PHIẾU QUAY PHIM HẬU MÔN - TRỰC TRÀNG","VIDEO-PROCTOSCOPY","BÁC SỸ CHẨN ĐOÁN","left",3,"quayphim_anus",'<?=$modules?>');
			}
  ...
  $("#builonnhat").keyup(function(e) {
	...
	$("#combo_ppdieutri11,#solandieutri1,#ppdieutricu1,#builonnhat1").attr("lang","luu");
		...
		$("#xoaloikhuyen").click(function(){
			...
			window.oper='xoalk';
			  ...
			  $("#hoantat").click(function(){
				...
				i = 0;
				dataToSend = '{';
				$('.thongtin_thai,.form_row,#panel_main').find(':input[type=text],select,textarea,input[type=hidden]').each(function() {
...
function dis_all(tam){
	if(tam=="an"){
	 $('#panel_main').find('input[type=text],input[type=checkbox],select,textarea,input[type=hidden]').each(function() {
		...
		$( "#tgmacbenh1,#solandieutri1,#ppdieutricu1,#sobuitri1,#builonnhat1,#combo_ppdieutri11" ).addClass( "backhidde" );
	...
	$( "#tgmacbenh1,#solandieutri1,#ppdieutricu1,#sobuitri1,#builonnhat1,#combo_ppdieutri11" ).removeClass( "backhidde" );
