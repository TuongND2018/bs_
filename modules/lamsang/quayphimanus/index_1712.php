...
$(document).ready(function() {
	...
	$.cookie("in_status", "print_preview"); 	
		...
		if($('#In_CoChuKy input:checkbox').is( ":checked" )){
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"quayphim_anus",print_action,"PHIẾU SOI HẬU MÔN - TRỰC TRÀNG","RECTO-ANAL-SCOPY","BÁC SỸ CHẨN ĐOÁN","left",3,"quayphim_anus",'<?=$modules?>');
		}else{
			dialog_pic_select("Chọn ảnh",90,"170px","jdshju8789789",window.search_string,"quayphim_anus",print_action,"PHIẾU SOI HẬU MÔN - TRỰC TRÀNG","RECTO-ANAL-SCOPY","BÁC SỸ CHẨN ĐOÁN","left",3,"quayphim_anus",'<?=$modules?>');
			}
