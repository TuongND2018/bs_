...
function dathuchien(){	
	...
	$chuoi='(?,?,?,?,?,?,?)';
	$params=  array($_POST["id_kham"],$_POST["nguoithuchien"],$_POST["soitructrang"],$_POST["text_chuandoan"],$_POST["ppdieutri1"],$_POST["ghichunoibo"],$_SESSION["user"]["id_user"]);
	$store_name="{call GD2_quayphim_anus_action_dathuchien $chuoi}";//tao bien khai bao store
	$data->query( $store_name, $params);
...
$data= new SQLServer;//tao lop ket noi SQL
	...
	$chuoi='(?,?,?,?,?,?)';
	$params=  array($_POST["id_kham"],$_POST["soitructrang"],$_POST["text_chuandoan"],$_POST["ppdieutri1"],$_POST["ghichunoibo"],$_SESSION["user"]["id_user"]);
	$store_name="{call GD2_quayphim_anus_action_luu_dangkham $chuoi}";//tao bien khai bao store
	$data->query( $store_name, $params);
...
$data= new SQLServer;//tao lop ket noi SQL
	...
	$chuoi='(?,?,?,?,?,?,?)';
	$params=  array($_POST["id_kham"],$_POST["nguoithuchien"],$_POST["soitructrang"],$_POST["text_chuandoan"],$_POST["ppdieutri1"],$_POST["ghichunoibo"],$_SESSION["user"]["id_user"]);
	$store_name="{call GD2_quayphim_anus_action_luu_dathuchien $chuoi}";//tao bien khai bao store
	$data->query( $store_name, $params);
}
function hoantat(){
	$data= new SQLServer;//tao lop ket noi SQL
	...
	$chuoi='(?,?,?,?,?,?,?,?)';
	$params=  array($_POST["id_kham"],$_POST["nguoithuchien"],$_POST["chuandoan1"],$_POST["soitructrang"],$_POST["text_chuandoan"],$_POST["ppdieutri1"],$_POST["ghichunoibo"],$_SESSION["user"]["id_user"]);
	$store_name="{call GD2_quayphim_anus_action_hoantat_new $chuoi}";//tao bien khai bao store
	$data->query( $store_name, $params);
}
function luuhoantat(){
$data= new SQLServer;//tao lop ket noi SQL
	...
	$chuoi='(?,?,?,?,?,?,?)';
	$params=  array($_POST["id_kham"],$_POST["chuandoan1"],$_POST["soitructrang"],$_POST["text_chuandoan"],$_POST["ppdieutri1"],$_POST["ghichunoibo"],$_SESSION["user"]["id_user"]);
	$store_name="{call GD2_quayphim_anus_action_luu_hoantat $chuoi}";//tao bien khai bao store
	$data->query( $store_name, $params);
