...
function create_ds_grid(){	
	 ...
	 $("#rowed3").jqGrid({
		...
		datatype: "json",	
		colNames:['TT','ID_BenhNhan',"Mã BN", "Họ tên", "Tuổi", "Giới", "Phân loại khám","idloaikham","Trạng thái", "Giờ đến", "Ghi chú", "Lịch sử"],
colModel:[
               ...
               // mtype: 'post',				 			
                addRowParams: {
					...
					oneditfunc: function(rowId) {						
					   ...
					   if(tmp2.length>1){						  
						    var rowData2 = $("#rowed7").getRowData(tmp1[tmp2.length-2]);						
					   }else{						    
						    var rowData2 = $("#rowed7").getRowData(tmp2[0]);	
					   }
