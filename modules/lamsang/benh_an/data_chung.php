...
$store_name="{call  spKham_SelectDieuTriByID_LuotKham(?,?)}";//tao bien khai bao store
...
echo number_format(round($tam[0]['PhiThucHien']/1000)+round($tam[0]['tienthuoc']/1000), 0, '', '.').'('.number_format((round($tam[0]['tienvonkham']/1000)+round($tam[0]['tienvonthuoc']/1000)), 0, '', '.').')/'.number_format(round($tam[0]['tienthuoc']/1000), 0, '', '.').'('.number_format(round($tam[0]['tienvonthuoc']/1000), 0, '', '.').')/'.number_format(round($tam[0]['giamgia']/1000), 0, '', '.');
