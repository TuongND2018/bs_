...
<body id="wrapper">
    <?php
		...
		if(!isset($thongtinbenhnhan2[0]["TenPhongKham"])){    
            $thongtinbenhnhan2[0]["TenPhongKham"]="1";
        }else{    
    ...
    <table class="container"cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Tahoma, Geneva, sans-serif;color:#036;;font-size:13px">        
      ...
      <table cellpadding="0" cellspacing="0" border="0" style="color:#036;font-size:13px; width:100%;font-family:Tahoma, Geneva, sans-serif; border-top:0px solid #000;  padding:5px 0px">           
         <tr>
              <td valign="middle"><button type="button" id="luuphieu">Lưu phiếu khám</button>
                    <button type="button" id="taobenhannoitru">Tạo bệnh án nội trú</button>
                     <button type="button" id="inphieu">In Phiếu</button>
                     <span id="In_CoChuKy"><input type="checkbox" checked="checked" /> In có chữ ký</span>
              </td>
             ...
             if($('#In_CoChuKy input:checkbox').prop('checked')==true)	
		{
			var chuky=1;
              ...
              $.cookie("in_status", "print_preview"); 
                                                            dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=phieuvaovien&header=top&id_benhnhan="+id_benhnhan+"&id_luotkham="+id_luotkham+"&id_kham="+id_kham+"&type=report&id_form=10&chuky="+chuky,'PhieuVaoVien');
