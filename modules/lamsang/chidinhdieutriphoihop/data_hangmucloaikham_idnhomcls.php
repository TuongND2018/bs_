...
$store_name="{call GD2_DM_SelectLoaiKhamByID_NhomCLSAndID_LuotKham_FixBHYT2015(?,?)}";//tao bien khai bao store
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
	...
	$baohiemchitra=$row["GiaBaoHiem"]-(($row["GiaBaoHiem"]*$phantramcungchitra)/100); //Color
