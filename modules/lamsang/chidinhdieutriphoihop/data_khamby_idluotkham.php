...
foreach ($tam as $row) {//duyet toan bo mang tra ve
  ...
  if($thanhtienbaohiem>0){
	  $bh=1;
  }else{
	  $bh=0;
  }
    $responce->rows[$i]['cell']=array($bh,$row["idloaikham"],"", $row["idloaikham"],$giabaobn,$giabaohiem,$giabaobn-$giabaohiem,$slmoingay, $songay, $thanhtienbaohiem,$bnchitra,$phithuchien, $idtrangthai, $thuchien, $bschidinh,"","","","", $row["ID_Kham"],"","","","","",1, $IDNhomCLS, $row["NgayGioTao"],$phithuchientheonhom,$Id_phy_dtph,$lanchidinh,$phantramcungchitra,$thanhtiencungchitra,$row['Color']);
    $i++; 
}
