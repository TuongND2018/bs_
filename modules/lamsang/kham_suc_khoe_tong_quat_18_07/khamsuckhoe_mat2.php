...
<table  cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:arial, Geneva, sans-serif;padding-left:5px; font-size:14px;">
  <tr>
    ...
    <td width="50%" align="center" style="padding-right:10px;">Đà Nẵng, Ngày <?php echo date("d")." tháng " . date("m")." năm " .  date("Y"); ?></td>
</tr>
<td width="50%" style="padding-left:10px;" align="center">Giám đốc chuyên môn <br /> <img src="./modules/report/lamsang/img/khamsuckhoetongquat/nhuvtq_241_sign.jpg"  width="100"/><br />
<b style="color:red">BS. Võ Thị Quỳnh Như</b>
</td>
    <td width="50%" align="center" style="padding-right:10px;">Bác sỹ kết luận <br />
