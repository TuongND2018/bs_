...
$params = array($_GET["idkham"],$_GET["idbenhnhan"]);//tao param cho store 
$store_name="{call GD2_KhamSucKhoeCongTy_KhamGetDataByID_KhamAndIDBenhNhan(?,?)}";//tao bien khai bao store
