...
<body>
<div id="dialog-print" title="Download complete" style="display:none;">
  <p>
        ...
        <div class="ui-widget-content ui-layout-west left_col">
             ...
             <div id="taimuihong" class="n_bd">
                ...
                <label class="n_title">TAI - MŨI - HỌNG </label>
                 ...
                 <table  id="tai_mui_hong">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="tmh_phanloai" name="tmh_phanloai" class="phanloai">
                           <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="ranghammat" class="n_bd">
                ...
                <label class="n_title">RĂNG - HÀM - MẶT </label>
                 ...
                 <table  id="tranghammat">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="rhm_phanloai" name="rhm_phanloai" class="phanloai">
                          <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div class="l_top">
                ...
                <table  id="tdalieu">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="dalieu_phanloai" name="dalieu_phanloai" class="phanloai">
                            <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="noikhoa" class="n_bd">
                ...
                <label class="n_title">NỘI KHOA </label>
                 ...
                 <table  id="tnoikhoa">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="noikhoa_phanloai" name="noikhoa_phanloai" class="phanloai">
                               <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="ngoaikhoa" class="n_bd">
                ...
                <label class="n_title">NGOẠI KHOA </label>
                 ...
                 <table  id="tngoaikhoa">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="ngoaikhoa_phanloai" name="ngoaikhoa_phanloai" class="phanloai">
                             <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="sanphukhoa" class="n_bd">
                ...
                <label class="n_title">SẢN PHỤ KHOA </label>
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="sanphukhoa_phanloai" name="sanphukhoa_phanloai" class="phanloai">
                              <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
            ...
            <div id="tuanhoan" class="n_bd">
                ...
                <label class="n_title ">TUẦN HOÀN </label>
                 ...
                 <table  id="ttuanhoan">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="tuanhoan_phanloai" name="tuanhoan_phanloai" class="phanloai">
                              <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="hohap" class="n_bd">
                ...
                <label class="n_title">HÔ HẤP </label>
                 ...
                 <table  id="thohap">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="hohap_phanloai" name="hohap_phanloai" class="phanloai">
                               <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="tieuhoa" class="n_bd">
                ...
                <label class="n_title">TIÊU HÓA </label>
                 ...
                 <table  id="ttieuhoa">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="tieuhoa_phanloai" name="tieuhoa_phanloai" class="phanloai">
                               <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="thantietnieusinhduc" class="n_bd">
                ...
                <label class="n_title">THẬN - TIẾT NIỆU - SINH DỤC </label>
                 ...
                 <table  id="tthantietnieusinhduc">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="thantietnieusinhduc_phanloai" name="thantietnieusinhduc_phanloai" class="phanloai">
                              <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div class="l_top">
                ...
                <table  id="tthankinh">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="thankinh_phanloai" name="thankinh_phanloai" class="phanloai">
                               <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="tamthan" class="n_bd">
                ...
                <label class="n_title">TÂM THẦN </label>
                 ...
                 <table  id="ttamthan">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="tamthan_phanloai" name="tamthan_phanloai" class="phanloai">
                             <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="hevandong" class="n_bd">
                ...
                <label class="n_title">HỆ VẬN ĐỘNG </label>
                 ...
                 <table  id="thevandong">
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="hevandong_phanloai" name="hevandong_phanloai" class="phanloai">
                             <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
             ...
             <div id="noitiet" class="n_bd">
                ...
                <label class="n_title">NỘI TIẾT </label>
                  ...
                  <tr>
                    <td>Phân loại: </td>
                    <td><select lang="luu" id="noitiet_phanloai" name="noitiet_phanloai" class="phanloai">
                             <option value="1">1</option>
                           <option value="2">2</option>
                           <option value="3">3</option>
                           <option value="4">4</option>
...
window.nhanvien_complete=0;
	...
	create_combobox('#m_bacsy', '#m_bacsy1', ".data_combo_bacsy3", "#data_combo_bacsy3", create_bacsi, 500, 400, 'Người thực hiện', 'data_bacsi');
	...
	function n_loadform(){
		...
		_id_kham2.splice(0, _id_kham2.length-1)
...
function navigator_load(_value,_click){
	//alert(_value);
	if((navigator_count+_value>_id_kham2.length-1)||(navigator_count+_value<0)){
		return false;	
	}
	var tam_cls=""; 
	if(_value=="first"){
		...
		navigator_count=_id_kham2.length-1;
	}else{
	...
	$.each( data_luotkham, function( key, val ) {					 
		for(i=0;i<val.length;i++){
			//tam+=" ; "+val[i]["id"];				
			var tam1_cls=val[i]["cell"];
			//console.log(tam1_cls);
			//alert(_id_kham[navigator_count]+":"+tam1_cls[69])
			if(_id_kham2[navigator_count]==tam1_cls[69]){
				//alert(_id_kham[navigator_count]) 
			//	alert(tam1_cls[0]);
				if(tam1_cls[0]=='KSKCty_65')
					var k='Khám sức khỏe công ty';
					else
						var k=tam1_cls[0];
	...
	$("#left_col .navigator_title").html("Lần " + (navigator_count+1) +"/"+_id_kham2.length);	
...
function loaikham_click(){
	$.each( data_luotkham, function( key, val ) {
		...
		$("#left_col div div").click(function(e) {
				...
				////////
				var ii=0;	
				//alert("nam"+_id_kham.length);			 
				for(i=0;i<_id_kham.length;i++){
	
					//if(_id_kham[i]==_id_kham){						 				 
