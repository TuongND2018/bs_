...
$(document).ready(function(e) {
	...
	/*{name: 'ThuocThongThuong', index: 'ThuocThongThuong', search: true, width: "10%", editable: false, align: 'left', hidden: false},
	{name: 'VatTuYTe', index: 'VatTuYTe', search: true, width: "10%", editable: false, align: 'left', hidden: false},
	{name: 'ThuocHuongThan', index: 'ThuocHuongThan', search: true, width: "10%", editable: false, align: 'left', hidden: false},*/
