...
jQuery(document).ready(function() {
	...
	$("#tailai,#capnhatchucnangsong,#phieulinhthuoc,#phieuhoantrathuoc,#xemtatca,#dsdaravien").button();
	phanquyen();
})	
...
function create_grid(){
	//window.kiemtrasearch = true;
	 $("#rowed3").jqGrid({
		...
		//url:'',
		datatype: "json",
		colNames:['Mã BN',"Họ lót BN","Tên BN","Tuổi","Giới","Đối tượng", 'Địa chỉ','Người tạo','Giờ tạo','Ngày tạo','Tên loại bệnh án','Chẩn đoán nơi chuyển đến','Chẩn đoán Khoa điều trị','BS. Điều trị','ID_LuotKham','ID_LoaiBenhAnNoiTru','ID_BenhNhan','ID_PhongBan','NgayTaoBenhAn'],
		colModel:[
			...
			{name:'CD_NoiChuyenDen',index:'CD_NoiChuyenDen', width:"15%", editable:false,align:'left',hidden:false},
		...
		onRightClickRow: function(rowid, iRow, iCol, e) {
			...
			if(rowData["ID_LoaiBenhAnNoiTru"]==""){
				...
				$("#benhannoikhoa2,#benhanngoaikhoa2,#benhansankhoa2,#benhansanphukhoa2,#benhanranghammat2,#benhannhikhoa2,#benhantaimuihong2,#benhanmat_lacvannhan2,#benhanmat_glocom2,#benhanmat_streem2,#benhansosinh2").hide();
				$("#benhannoikhoa,#benhanngoaikhoa,#benhansankhoa,#benhansanphukhoa,#benhanranghammat,#benhannhikhoa,#benhantaimuihong,#benhanmat_lacvannhan,#benhanmat_glocom,#benhanmat_streem,#benhansosinh").show();
			}else{
				if ($.trim(rowData[colName]) != "") {
					window.rowid_danhcho = rowid;
					window.from = colModel[iCol].name;
				...
				$("#benhannoikhoa,#benhanngoaikhoa,#benhansankhoa,#benhansanphukhoa,#benhanranghammat,#benhannhikhoa,#benhantaimuihong,#benhanmat_lacvannhan,#benhanmat_glocom,#benhanmat_streem,#benhansosinh").hide();
				$("#benhannoikhoa2,#benhanngoaikhoa2,#benhansankhoa2,#benhansanphukhoa2,#benhanranghammat2,#benhannhikhoa2,#benhantaimuihong2,#benhanmat_lacvannhan2,#benhanmat_glocom2,#benhanmat_streem2,#benhansosinh2").show();
