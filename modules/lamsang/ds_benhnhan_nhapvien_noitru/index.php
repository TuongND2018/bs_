...
<ul id="menu" style="display:none" > 
    ...
    <li><a id="benhanphuchoichucnangngoaitru" href="#"><span class="ui-icon ui-icon-note"></span><span class="menu_text">Bệnh án phục hồi chức năng (ngoại trú)</span></a></li>
</ul>
<ul id="menu2" style="display:none" > 
    ...
    <li><a id="benhanphuchoichucnangngoaitru2" class="n_menu2 ui-state-disabled" href="#"><span class="ui-icon ui-icon-note"></span><span class="menu_text">Bệnh án phục hồi chức năng (ngoại trú)</span></a></li>
...
jQuery(document).ready(function() {
	...
	$("#benhanphuchoichucnangngoaitru").bind("click", function(e) {
		var selr = jQuery('#rowed3').jqGrid('getGridParam','selrow');
		var rowData = jQuery('#rowed3').getRowData(window.rowselect);
			parent.postMessage('open_idluotkham;benh_an_ngoai_vltl;'+rowData['ID_LuotKham']+';'+rowData['ID_BenhNhan']+';;;&id_benhannoitru='+window.rowselect+'&idloaibenhan=13&tenbenhnhan='+rowData["HoLotBenhNhan"]+' '+rowData["TenBenhNhan"]+'&ngaytaobenhan='+rowData["NgayTaoBenhAn"]+'&idkhoa='+window.idphongban,'*');

	}); //Bệnh án phục hồi chức năng ngoai tru
	 ...
	 $("#rowed3").jqGrid({
		...
		ondblClickRow: function (rowId, rowIndex, columnIndex) {
			...
			if(rowData["ID_LoaiBenhAnNoiTru"]==1){
				...
				parent.postMessage('open_idluotkham;benh_an_dieu_duong_phcn;'+rowData['ID_LuotKham']+';'+rowData['ID_BenhNhan']+';;;&id_benhannoitru='+window.rowselect+'&idloaibenhan=12&tenbenhnhan='+rowData["HoLotBenhNhan"]+' '+rowData["TenBenhNhan"]+'&ngaytaobenhan='+rowData["NgayTaoBenhAn"]+'&idkhoa='+window.idphongban,'*');
			}else if(rowData["ID_LoaiBenhAnNoiTru"]==13){
				parent.postMessage('open_idluotkham;benh_an_ngoai_vltl;'+rowData['ID_LuotKham']+';'+rowData['ID_BenhNhan']+';;;&id_benhannoitru='+window.rowselect+'&idloaibenhan=13&tenbenhnhan='+rowData["HoLotBenhNhan"]+' '+rowData["TenBenhNhan"]+'&ngaytaobenhan='+rowData["NgayTaoBenhAn"]+'&idkhoa='+window.idphongban,'*');
			}else{
