...
function create_grid(){ 
   $("#rowed3").jqGrid({
    ...
    colNames: ['id','id_bn','Mã BN', 'Tên bệnh nhân','Nội dung thực hiện','Ghi chú','Đã hoàn tất','','',''],
            colModel: [
                ...
                {name: 'NgayGioTao', index: 'NgayGioTao', hidden: false,width:90,summaryType: 'sum',formatter:tomaughichuchamcong},
            ],
  //
 ...
 $( "#dialog-form" ).dialog({
  ...
  function tomaughichuchamcong(cellvalue, options, rowObject) {
    ...
    console.log(ngayT);
    //alert (ngayT);
        return  '<span style="color:red">' + ngayT +'</span>';
    }
...
function create_grid3(){ 
   ...
   colNames: ['id','id_bn','Mã BN', 'Tên bệnh nhân','Nội dung thực hiện','Ghi chú','Đã hoàn tất','','',''],
            colModel: [
                ...
                {name: 'ID_LuotKham', index: 'ID_LuotKham', hidden: false,width:90,summaryType: 'sum'},
                {name: 'ID_Physiotherapy', index: 'ID_Physiotherapy', hidden: true,width:90},
