...
jQuery(document).ready(function() {
	...
	jQuery(window).resize(function() {		 
	 ...
	 $("#rowed3").setGridHeight($(window).height()-$("#").height()-150);
	});
...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_trinhdo',
		datatype: "json",	
		colNames:['Id','Tên Nhóm Phân Loại Thuốc','Ghi Chú','Sử dụng'],
		colModel:[
			{name:'ID_PhanLoaiThuoc',index:'ID_PhanLoaiThuoc',search:false,search:false, width:"2%", editable:false,align:'right',hidden:true}, 
			{name:'TenNhom',index:'TenNhom',search:true, width:"30%", editable:true,align:'center',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			{name:'GhiChu',index:'GhiChu',search:true, width:"20%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{ rowpos:2, colpos:1}},	 
	...
	//
		...
		caption: "Danh mục phân loại thuốc"
	});	
