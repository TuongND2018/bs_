...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_duongdung',
		datatype: "json",	
		colNames:['ID_DuongDung','Tên Đường Dùng','Ghi Chú','Active'],
		colModel:[
                        {name:'ID_DuongDung',index:'ID_DuongDung',search:false, width:"2%", editable:false,align:'right',hidden:true},
			{name:'TenDuongDung',index:'TenDuongDung', width:"20%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
