...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_quoctich',
		datatype: "json",	
		colNames:['Id','Tên Quốc Tịch','Hệ số viện phí','Sử dụng','Mô tả'],
		colModel:[
			{name:'ID_QuocTich',index:'ID_QuocTich',search:false, width:"2%", editable:false,align:'right',hidden:true}, 
			{name:'TenQuocTich',index:'TenQuocTich', width:"20%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			{name:'HeSoVienPhi',index:'HeSoVienPhi', width:"10%", editable:true,align:'left',hidden:false,edittype:"text", formatter:"number",formoptions:{ rowpos:6, colpos:1}, editrules:{number:true,required:true}},	 
			{name:'Active',index:'Active', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:3, colpos:1},editoptions: {value:"1:0"},stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}},
	...
	//jsonReader:{repeatitems:true,subgrid:{repeatitems:false}},	
		...
		caption: "<?php get_text("dm_quoctich")?>"
	});	
