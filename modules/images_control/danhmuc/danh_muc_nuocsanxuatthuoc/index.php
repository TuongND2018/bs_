...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_nuocsanxuatthuoc',
		datatype: "json",	
		colNames:['Id','Tên đầy đủ','Tên viết tắt','Ghi chú','Sử dụng'],
		colModel:[
			{name:'ID_NuocSanXuat',index:'ID_NuocSanXuat',search:false, width:"2%", editable:false,align:'right',hidden:true}, 
			{name:'TenDayDu',index:'TenDayDu', width:"15%", editable:true,align:'letf',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			{name:'TenVietTat',index:'TenVietTat', width:"15%", editable:true,align:'letf',hidden:false,editrules: {required:false},edittype:"text",formoptions:{ rowpos:2, colpos:1}}, 			
	...
	//
		...
		caption: "Danh mục nước sản xuất thuốc"
	});	
