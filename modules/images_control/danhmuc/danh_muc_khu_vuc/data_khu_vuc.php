...
$params = array("DM_KhuVuc");//tao param cho store 
...
$store_name="{call GD2_DM_Khuvucgetby (?,?,?,?,?)}";//tao bien khai bao store
...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["ID_KhuVuc"],$row["TenKhuVuc"],$row["MoTa"],$row["Active"],$row["STT"],$row["TangLau"]);
    $i++; 
}   
