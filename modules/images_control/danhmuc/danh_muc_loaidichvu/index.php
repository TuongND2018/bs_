...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_loaidichvu',
		datatype: "json",	
		colNames:['Id','Tên loại dịch vụ','Sử dụng'],
		colModel:[
			{name:'Id_Loaidichvu',index:'Id_Loaidichvu',search:false, width:"2%", editable:false,align:'right',hidden:true}, 
			{name:'TenLoaiDichVu',index:'TenLoaiDichVu', width:"70%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			{name:'SuDung',index:'SuDung', width:"5%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:1, colpos:2},editoptions: {value:"1:0",defaultValue:'1'},stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}},
		],
	//
