...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["ID_XetNghiem"],$row["TenXetNghiem"],$row["MoTa"],$row["DonGia"],$row["GhiChu"],$row["CanNam1"],$row["CanNam2"],$row["CanNam3"],
    	...
    	$row["GiaTriBinhThuong2"],$row["CoKQInRieng"],$row["CoTemplate"],$row["STT"],$row["ID_DonViTinh"]);
    $i++; 
}
