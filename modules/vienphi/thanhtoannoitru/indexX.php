...
$('#btn_hdKhamCb').click(function(){
           ...
           dialog_main("Hóa đơn khám CB Nội trú chi tiết "+ID_ThuTraNo+  '   ', 90, 90, "56743265743657", "resource.php?module=vienphi>&view=hoadon&action=HDChiTiet&type=test&id_form=11&ID_ThuTNo="+ID_ThuTraNo+"&phanloaiHD=1");
        })
          $('#btn_gtgt').click(function(){

           dialog_main("Hóa đơn thuốc nội trú chi tiết "+ID_ThuTraNo+  '   ', 90, 90, "56743265743657", "resource.php?module=vienphi>&view=hoadon&action=HDChiTiet&type=test&id_form=11&ID_ThuTNo="+ID_ThuTraNo+"&phanloaiHD=2");
        })
