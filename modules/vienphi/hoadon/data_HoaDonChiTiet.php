...
switch ($_GET["phanloaiHD"]) {
	case '1'://hóa đơn khám chữa bệnh ngoại trú
		...
		case '11'://bảng kê thuốc ngoại trú
		HoaDon_BangKe_ThuocNgoaiTru();
		break;

			case '8'://bảng kê KCB nội trú
		HoaDon_BangKe_KhamChuaBenhNoiTru();
		break;

		case '10'://bảng kê thuốc nội trú
		HoaDon_BangKe_ThuocNoiTru();
		break;
	default:
		# code...
		# code...
...
function HoaDon_BangKe_KhamChuaBenhNoiTru()
{
		$data= new SQLServer;
		$store_name="{call GD2_BangKe_KhamChuaBenhNgoaiTru(?)}";
		$params = array($_GET["ID_ThuTraNoMulti"]);
...
function HoaDon_BangKe_ThuocNgoaiTru()
{
$data= new SQLServer;
$store_name="{call GD2_BangKeThuocNgoaiTru(?)}";
$params = array($_GET["ID_ThuTraNoMulti"]);
$get_lich=$data->query( $store_name, $params);
$excute= new SQLServerResult($get_lich);
$tam= $excute->get_as_array();
...
function HoaDon_BangKe_ThuocNoiTru()
{
$data= new SQLServer;
$store_name="{call GD2_BangKeThuocNoiTru(?)}";
$params = array($_GET["ID_ThuTraNoMulti"]);
$get_lich=$data->query( $store_name, $params);
$excute= new SQLServerResult($get_lich);
$tam= $excute->get_as_array();
