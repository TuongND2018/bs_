...
$NgayGioHuy="";
 if (isset($row["NgayGioHuy"])) {
$NgayGioHuy=  $row["NgayGioHuy"]->format('d/m/y H:i');

}


$NgayKham=$row["NgayLap"]->format('d/m/y H:i');

//$ChiTietBangKe="<a href='#' id='open_chitietbangke'>Bảng kê chi tiết </a>";
$ChiTietBangKe="Bảng kê chi tiết";
