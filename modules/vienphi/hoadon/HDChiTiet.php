 ...
 <label for="maST">Mã số thuế</label>
        ...
        <textarea id ="ghichu" name="ghichu"  style="width:137px!important"  disabled></textarea>
          ...
          <input type="text" name="miengiam" id="miengiam" />
           <label for="phantramthue">PT thuế</label>
          <input type="text" name="phantramthue" style="width:110px!important" id="phantramthue"/>
...
<script type="text/javascript">
    ...
    jQuery(document).ready(function() {
     ...
     {
           window.url_rowed30 = 'resource.php?module=vienphi>&view=hoadon&action=data_HoaDonChiTiet&ID_ThuTraNo='+ window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+'&ID_ThuTraNoMulti='+window.ID_ThuTraNoMulti

         }else
         {
               window.url_rowed30 = 'resource.php?module=vienphi>&view=hoadon&action=data_HoaDonChiTiet&ID_ThuTraNo='+ window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD;;
...
if(typeof window.ID_ThuTraNoMulti !='undefined'){
 ...
 $.post('resource.php?module=vienphi&view=hoadon&action=controller_luuHoaDon&hienmaloi=3&ID_TTNo='+ID_ThuTNo,dataToSend)
                                 .done(function( data ) {
                                  ...
                                  tooltip_message("Thêm hóa đơn thành công");
                                    ...
                                    {
                                        tooltip_message("Lưu không thành công- do số hóa đơn đã tồn tại");
                                    }
                                                                  })
                                                        .fail(function() {
                                                        alert( "error" );
...
function resize_control() {
 ...
 $('#XemIn').click(function(){
      ...
      $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=vienphi&action=hoadonchinhthuc&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'HoaDonChinhThuc');
          $('#dialog_print').dialog('close');

        })
  $('#BangKe').click(function(){

if(window.phanloaiHD=='6'||window.phanloaiHD=='10'||window.phanloaiHD=='5')
{
      $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=vienphi&action=bangkehoadon&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'BangKeHoaDon');
          $('#dialog_print').dialog('close');
}
  else if(window.phanloaiHD=='9'||window.phanloaiHD=='8'||window.phanloaiHD=='7'||window.phanloaiHD=='1')
  {
    $.cookie("in_status", "print_preview");
           dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=vienphi&action=BangKeHoaDonKCB&header=top&lien=3&type=report&id_form=11&kieuin=1&id_ttno="+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+"&ID_HoaDonThueDiary="+_ID_HoaDonThueDiary+"&ID_ThuTraNoMulti="+window.ID_ThuTraNoMulti,'BangKeHoaDonKCB');
          $('#dialog_print').dialog('close');
  }
 ...
 $('#Huy').click(function(){
  ...
  .dialog({
    ...
    buttons: {
      Yes: function () {
        postTo='resource.php?module=vienphi&view=hoadon&action=controller_luuHoaDon&opper=HuyHoaDon'+'&soHdHuy='+soHdHuy+'&_ID_HoaDonThueDiary='+_ID_HoaDonThueDiary;
 ...
 function LayDuLieuLoadForm(ID_ThuTraNoP)
 {
  var postTo;
if(typeof window.ID_ThuTraNoMulti !='undefined'){
    postTo='resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_ThongTinHoaDon&ID_ThuTraNo='+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+'&IDHoaDonThueDiary='+window.ID_HoaDonThueDiary+'&ID_ThuTraNoMulti='+window.ID_ThuTraNoMulti;

}
else
{
  postTo='resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_ThongTinHoaDon&ID_ThuTraNo='+window.ID_ThuTNo+'&phanloaiHD='+window.phanloaiHD+'&IDHoaDonThueDiary='+window.ID_HoaDonThueDiary;
}
  $.post(postTo).done(function(data){
