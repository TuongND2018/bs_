...
$dem1=0;
		...
		foreach ($tam as $row){								
			if($mangnhanvien[$i]==$row["ID_NhanVien"])
			{				
				$dulieugoc[$row["ID_NhanVien"]][]=$row["Ngay"]->format('Y-m-d').";".$row["ID_NhanVien"].";".$row["TenLoaiLich"].";".$row["GioBatDau"].";".$row["GioKetThuc"].";".$row["Colour"].";".$row["IsChamCong"] ;
