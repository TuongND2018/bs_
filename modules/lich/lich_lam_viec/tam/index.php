...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_phong_ban&q=2',
		datatype: "json",	
		...
		colModel:[
			...
			{name:'TenPhongBan',index:'TenPhongBan', width:"17%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{rowpos:1 , colpos :1},sorttype:'text'},
			{name:'ID_PhongBanCha',index:'ID_PhongBanCha',search:false, width:"15%", editable:true,align:'center',formatter:"select",edittype:"select",hidden:false,editoptions:{value:phongban},formoptions:{rowpos:1 , colpos :2}},		 
			{name:'MoTa',index:'MoTa',search:false, width:"20%", editable:true,align:'center',hidden:false,edittype:"textarea",formoptions:{rowpos:4, colpos :2}}, 
			{name:'DienThoai',index:'DienThoai',search:false, width:"10%", editable:true,align:'center',hidden:false,edittype:"text",formoptions:{rowpos:2, colpos :1}}, 
			{name:'IsPhongChuyenMon',index:'IsPhongChuyenMon',search:false, width:"5%",editable: true,align:'center',hidden:false,edittype:"checkbox",editoptions: {value:"1:0"},formatter:"checkbox",formatoptions:{"disabled":true}}, 
			{name:'ID_KhuVuc',index:'ID_KhuVuc',search:false, width:"10%", editable:true,align:'center',edittype:"select",formatter:"select",hidden:false,editoptions:{value:window.khuvuc},formoptions:{rowpos:2, colpos :2,elmsuffix:'<a id="sKhuvuc" class="open_new_modal fm-button ui-state-default ui-corner-all fm-button-icon-left" href="#"><span class="ui-icon ui-icon-newwin"></span>Thêm</a>'}}, 
			{name:'ID_CongTy',index:'ID_CongTy',search:false, width:"10%", editable:true,align:'center',edittype:"select",formatter:"select",hidden:false,editoptions:{value:window.congty},formoptions:{rowpos:3, colpos :2}}, 
			...
			{name:'KhoangCachDenPhongKhamLS',search:false,index:'KhoangCachDenPhongKhamLS', width:"5%", editable:true,align:'center',hidden:false,formoptions:{rowpos:3, colpos :1}},   	 	 
		],
		loadonce: false,
		scroll: false,		 
		modal:true,	 	 
    ...
    deltext: 'Xóa (F8)',searchtext: 'Tìm kiếm (F9)',refreshtext: 'Tải lại (F10)', edit: permission["edit"], del: permission["delete"], search: permission["search"],closeAfterEdit: true,clearAfterAdd :true,closeOnEscape : true,}, //options						 
			   ...
			   afterSubmit : function(response, postdata) { 
				...
				afterShowForm : function (formid) {
					...
					$("#sKhuvuc").click(function(e){		 
						...
						links="resource.php?module=danhmuc&view=danh_muc_khu_vuc&id_form=10"
		...
		{reloadAfterSubmit:true,height:250,width:600,sopt: ["cn"],url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_phong_ban&q=2',navkeys : [ true, 38, 40 ],closeOnEscape : true,
