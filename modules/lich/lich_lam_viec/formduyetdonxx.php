        ...
        function create_grid_sucobynhanvien() {
            ...
            $("#rowed3").jqGrid({
                ...
                colModel: [
                   ...
                   {name:'Finished',index:'Finished', width:"5%", editable:true,stype: 'text',search:true,searchoptions: { sopt: ['eq', 'ne'],value:':Tất cả;1:OK;0:NoOK'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"select",formatoptions:{disabled: false},formoptions:{ rowpos:13, colpos:1}
