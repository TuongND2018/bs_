...
<script type="text/javascript">
 ...
 var id_pb=19;
        ...
        function create_grid_sucobynhanvien() {
            ...
            $("#rowed3").jqGrid({
                url: 'resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=data_xem_nhanvien_An&id_pban='+ id_pban,
                datatype: "json",
              ...
              loadonce: true,
                ...
                cellEdit: true,
                cellsubmit: 'remote',
                cellurl: 'resource.php?module=<?= $modules ?>&view=<?= $view ?>&action=controller_An&hienmaloi=3&oper=hienthilich',
