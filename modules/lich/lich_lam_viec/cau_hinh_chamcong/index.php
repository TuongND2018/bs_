	...
	var quyenxemfullreport=1
	 ...
	 $("#rowed3").jqGrid({
		...
		colModel:[
			...
			{name:'Ghichu',index:'Ghichu', width:"25%", editable:true,align:'left',hidden:false,editrules: {required:true},formatter:"select",edittype:"text",},
			{name:'IsHeThongGlobal',index:'UserWindowName', width:"10%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"checkbox",},
