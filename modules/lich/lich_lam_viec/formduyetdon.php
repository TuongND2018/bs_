        ...
        function create_grid_sucobynhanvien() {
            ...
            $("#rowed3").jqGrid({
                ...
                colModel: [
                   ...
                   {name:'Finished', stype: 'select',index:'Finished', width:"5%", search:true,searchoptions: { sopt: ['eq', 'ne'],value:':Tất cả;1:OK;0:NoOK'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"select",
