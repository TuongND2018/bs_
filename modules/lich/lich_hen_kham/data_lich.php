...
$gio1="<div class='hours'>"."</div>"."<div class='minutes'>".($ii*$system_config["GD2_KhoangThoiGianHenKham"])."</div>";
$gio2="<div class='minutes1'>".($ii*$system_config["GD2_KhoangThoiGianHenKham"])."</div>";
$end_point = $system_config["GD2_ThoiGianLamViec"]*(60/$system_config["GD2_KhoangThoiGianHenKham"])-1;
$step=60/$system_config["GD2_KhoangThoiGianHenKham"]-1;
...
for ($i=0;$i<=$end_point;$i++){
	...
	if($kiemtra==0){
		...
		$kiemtra++;
		$thoigian=$GD2_ThoiGianBatDau.":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];
		$ii++;			 
	}elseif($kiemtra==$step){
		$kiemtra=0;		
		$thoigian=$GD2_ThoiGianBatDau.":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];	
...
for ($i=0;$i<=$end_point;$i++){
	...
	if($kiemtra==0){
		...
		$kiemtra++;
		$thoigian1=$GD2_ThoiGianBatDau_tam.":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];
		$thoigian=$GD2_ThoiGianBatDau.":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];
		$responce->rows[$i]['id']=$GD2_ThoiGianBatDau.":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];
		//$responce->rows[$i]['id']=$ii;		
		$ii++;			 
	}elseif($kiemtra==$step){
		$kiemtra=0;	
...
/*for ($i=0;$i<=$end_point;$i++){
	...
	if($kiemtra==0){
		...
		$kiemtra++;
		$thoigian=$system_config["GD2_ThoiGianBatDau"].":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];
		$ii++;			 
	}elseif($kiemtra==$step){
		$kiemtra=0;		
		$thoigian=$system_config["GD2_ThoiGianBatDau"].":".$ii*$system_config["GD2_KhoangThoiGianHenKham"];	
