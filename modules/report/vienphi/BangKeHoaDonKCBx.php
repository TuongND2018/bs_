     ...
     <div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px">
       <div class="n_top">
         <table width="300px" border="0" align="left" cellpadding="0" cellspacing="0">
              <tr>
              <td align="center"><strong> CÔNG TY CP Y KHOA BÁC SỸ GIA ĐÌNH</strong>
              </td>
              </tr>
               <tr>
              <td align="center">73 Nguyễn Hữu Thọ - Đà Nẵng
              </td>
              </tr>
               <tr>
              <td align="center">ĐT : 0511.3652111   Fax 0511.3632333
              </td>
              </tr>
              <tr>
              <td align="center">-----***-----
...
1 113269  Nguyễn Thị Hải  Khám LS 0 1 1 0 -->
        ...
        <thead>
          <tr>
            ...
            <th width="430px">Tên dịch vụ KCB</th>
            <th width="70px">Số lần</th>
     ...
     if($row['STT3']==1)//dòng tổng cộng cho từng bệnh  nhân)
              {
               $sumBn=$sumBn+$row['ThanhTien'];
                $sttBN++;
                 echo ('<tr >
            <td colspan="5" style="height:21px!important;text-align:right;background:#F5F5F5;font-size:14px;font-family:Arial, Helvetica, sans-serif;font-style:italic; " ><b>'.$sttBN.'. '.$row['TenLoaiKham'] .'</b></td>
...
<script type="text/javascript">
	$(document).ready(function(e) { //180
	 ...
	 $('#total').html('<STRONG>Bằng chữ: '+toWords((<?=$sumBn?>).toString())+"đồng.</sTRONG>");
