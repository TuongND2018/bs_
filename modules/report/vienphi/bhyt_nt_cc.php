...
<?php
	...
	$data= new SQLServer;//tao lop ket noi SQL
		...
		$store_name2="{call GD2_BHCC_noitru_print(?)}";
...
<body>
    ...
    <tr>
     ...
     <tr>
    	<td style=" width:70%; text-align:left;"><strong>
    	  <?= $thongtinbhyt[0]['TenPhongBan']?>
    	</strong></td>
        <td style=" width:30%; text-align:center;"><strong>Mã số người bệnh:
            <?= $thongtinbhyt[0]['MaBenhNhan'] ?>
        </strong></td>
    </tr>
      <tr>
...
<tr><td style="text-align:left;">Họ tên người bệnh: <?= $thongtinbhyt[0]['HoLotBenhNhan'].' '.$thongtinbhyt[0]['TenBenhNhan']?></td>
...
<table>
<tr><td style="text-align:left;">Đến khám:  <?=$thongtinbhyt[0]['NgayGioVaoVien']->format('H').' giờ '.$thongtinbhyt[0]['NgayGioVaoVien']->format('i').' ngày '.$thongtinbhyt[0]['NgayGioVaoVien']->format('d/m/Y')?></td></tr>
</table>

<table>
<tr><td style="text-align:left;">Kết thúc đợt điều trị nội trú: <?php if($thongtinbhyt[0]['NgayGioRaVien']!=''){
	echo $thongtinbhyt[0]['NgayGioRaVien']->format('H').' giờ '.$thongtinbhyt[0]['NgayGioRaVien']->format('i').' ngày '.$thongtinbhyt[0]['NgayGioRaVien']->format('d/m/Y');}?></td>
<td style="text-align:right;">Tổng số ngày điều trị: <?php
...
<table>
<tr><td style="text-align:left;">Chẩn đoán: <?=$thongtinbhyt[0]['CD_KhoaDieuTri']?></td><td style="text-align:left;">Mã bệnh (ICD-10):  <?=$thongtinbhyt[0]['ICD_KhoaDieuTri']?></td></tr>
</table>
...
Số tiền người bệnh trả: <?=number_format(($bhyt[count($bhyt)-1]['nguoibenh']-$thongtinbhyt[0]['miengiam']),"0",",",".")?><br />
Nguồn khác:0</td></tr>

<tr style="border:none" style="font-size:12px;">	
	<td colspan="4" style="text-align:center;border:none"><br />
NGƯỜI LẬP BẢNG KÊ<br />
    (ký,ghi rõ họ tên)<br /><br /><br /><br /><br /><br />
