...
<body>
	...
	<?php
		...
		if(isset($_GET['tenreport'])){
			$tenreport='PHIẾU HOÀN TIỀN';
			$tenreport2='PHIẾU HOÀN TIỀN LIÊN 2';
		}else{
			$tenreport='PHIẾU CHI';
			$tenreport2='PHIẾU CHI LIÊN 2';
	...
	//	if(strtotime($thutrano[0]['NgayGioHenTraKQ']->format("H:i ".$_SESSION["config_system"]["ngaythang"]))<strtotime($thutrano[0]['NgayGio']->format("H:i ".$_SESSION["config_system"]["ngaythang"]))){
	...
	<h2 style="text-align:center; font-family:Arial, Helvetica, sans-serif;">'.$tenreport.'</h2>
   <table  cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        ...
        <td style="padding-top:10px;width:30%;">
            ...
            <td  style="padding-top:10px;font-weight:bold;font-size:15px;">
            '.number_format(abs($thutrano[0]['SoTien']),"0",",",".").'<sup>đ </sup>
            </td>
             </tr>
    </table>
    <br />
    <table  cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;page-break-after:always;">
       ...
       <tr  >
        ...
        <tr><td colspan="2" width="100%" style="text-align:center; font-size:18px; font-family:Arial, Helvetica, sans-serif; font-style:italic; background:#F5F5F5;">Thân thiết như người nhà</td>
        </tr>
    </table>';
	...
	<h2 style="text-align:center; font-family:Arial, Helvetica, sans-serif;">'.$tenreport2.'</h2>
   <table  cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
...
$(document).ready(function() { 
	$('#tongtien').html('('+toWords((<?=abs($thutrano[0]["SoTien"])?>).toString())+"đồng"+')');
