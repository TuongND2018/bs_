...
<?php
	...
	$data= new SQLServer;//tao lop ket noi SQL
		...
		$store_name2="{call GD2_BHYT_print_tam(?)}";
              ...
              <?php
				  ...
				  echo '</tr>';
				   ...
				   echo '<tr style=" border:1px solid #000;">';
						   ...
						   echo '<td style="border:solid 1px #000000 !important;text-align:right;">'.number_format($bhyt[count($bhyt)-1]['nguoibenh']-$bhyt[$i]['HoTroTuBenhVien'],"0",",",".").'</td>'; 
				  echo '</tr>';
			  ?>
              </tbody>
...
Số tiền người bệnh trả: <?=number_format($bhyt[count($bhyt)-1]['nguoibenh']-$bhyt[$i]['HoTroTuBenhVien'],"0",",",".")?><br />
Nguồn khác:0</td></tr>
...
<script type="text/javascript">
	...
	$('#sotien').html(toWords((<?=$bhyt[count($bhyt)-1]['nguoibenh']-$bhyt[$i]['HoTroTuBenhVien']?>).toString())+"đồng");
	 print_preview();
	});
</script>
</html>
