...
<body>
	<?php
       ...
       // $params = array($_GET['tungay'],$_GET['tungay']);//tao param cho store
         $params = array('2014-8-1','2014-8-15');//tao param cho store
        $store_name="{call GD2_TongHopSuatAnDangKyTheoNgayVaBuoi(?,?)}";//tao bien khai bao store
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Tahoma, Geneva, sans-serif;">
     	<tr>
             <td style="text-align:center"><br />
                 <span style="letter-spacing: 0.5px;font-weight:bold;font-size:26px;">HÓA ĐƠN KHÁM CHỮA BỆNH I</span>
                <br />
      ...
      <table bgcolor="#00FF00" cellpadding="0" cellspacing="0" border="0" style="width:95%;font-family:Tahoma, Geneva, sans-serif; font-size:13px; text-align:right">
    <?php

		echo ('<tr style=" border-top:2px solid #000;text-align:center"> <td width="10%" colspan="1"><b style="">Tên tầng</b></td>
		...
		for($i=0;$i<=count($thongtin)-1;$i++){
			...
			if($i<0){
				echo ('
				<tr style=" border-top:2px solid #000;"> <td width="240px" colspan="1" style="margin-left:10px; text-align:center">'.$thongtin[$i]['Id_Tang'].'</td>
