...
<body>
	<?php
	 ...
	 if($_GET['kieuin']==1){
	    ...
	    if($sotien_tienthuoc>0){
		   $kham=$kham.'<tr>
				<td  style=" width:60%; text-align:right; padding-top:5px; padding-bottom:10px; ">TIỀN THUỐC</td>
				<td style=" width:40%; text-align:right; padding-top:5px; padding-bottom:10px; ">'. number_format($sotien_tienthuoc,"0",",",".") .'</td>
				</tr>';
	     }
		  if($sotien_giuong>0){
		   $kham=$kham.'<tr>
				<td  style=" width:60%; text-align:right; padding-top:5px; padding-bottom:10px; ">TIỀN GIƯỜNG</td>
				<td style=" width:40%; text-align:right; padding-top:5px; padding-bottom:10px; ">'. number_format($sotien_giuong,"0",",",".") .'</td>
				</tr>';
	     }
	 ...
	 if($sotien_khamdt>0){
	   ...
	   if( $tam2[0]['nocu']+$tam2[0]['tamung']!=0){
		   ...
		   $nocu='  <tr  style="font-size:13px;">
            <td  style=" width:60%; text-align:right; padding-bottom:10px;">
            Nợ cũ:
            </td>
	  ...
	  $nomoi= ' <tr style="font-size:13px;" >
            <td  style=" width:60%; text-align:right;  padding-bottom:10px;">Nợ mới:
            </td>
            <td  style=" width:40%; text-align:right;  padding-bottom:10px; "><strong>
	  ...
	  $bhyt= ' <tr style="font-size:13px;" >
            <td  style=" width:60%; text-align:right;  padding-bottom:10px;">BHYT chi trả:
            </td>
            <td  style=" width:40%; text-align:right;  padding-bottom:10px; "><strong>
   			'. number_format($tam2[0]['TongTienBHYTChiTra'],"0",",",".").'đ</strong>
            </td>
        </tr>';
	   }
	  ...
	  $hotro= ' <tr style="font-size:13px;" >
            <td  style=" width:60%; text-align:right;  padding-bottom:10px;">Hỗ trợ:
            </td>
            <td  style=" width:40%; text-align:right;  padding-bottom:10px; "><strong>
   			'. number_format($tam2[0]['HoTroTuBenhVien'],"0",",",".").'đ</strong>
            </td>
        </tr>';
	   }
    ...
    <table  cellpadding="0" cellspacing="0"   style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;page-break-after:always;">
        <tr style="font-size:13px;">
            ...
            <td  style=" width:40%; text-align:right; font-weight:bold;padding-bottom:10px;">
           ...
           <tr style="font-size:13px;" >
            <td  style=" width:60%; text-align:right;  padding-bottom:10px;">Thanh toán đợt này:
            </td>
            <td  style=" width:40%; text-align:right;  padding-bottom:10px; ">
		 ...
		 <tr  style="font-size:13px;">
            ...
            <td colspan="2" style=" width:100%; text-align:right;  padding-bottom:10px; "><strong>'.$thongtinbenhnhan[0]['VietTat'].''.$thongtinbenhnhan[0]['HoLotNhanVien'].' '.$thongtinbenhnhan[0]['TenNhanVien'].''.'</strong></td>
        </tr>
		<tr>
        ...
        <tr>
        <td colspan="2" width="100%" style="text-align:center; font-size:18px; font-family:Arial, Helvetica, sans-serif; font-style:italic; background:#F5F5F5; padding-top:2px; padding-bottom:2px;"><p >Thân thiết như người nhà </p></td>
        </tr>
