...
elseif($_GET["phanloaiHD"]=='9'&& $_GET["ID_ThuTraNoMulti"]!="" )//hóa đơn bang kee KCBngoaij tgrus
{
...
if($_GET["phanloaiHD"]=='1'||$_GET["phanloaiHD"]=='7'||$_GET["phanloaiHD"]=='9')//in chi tiết khám bệnh
   {
...
<tr>
     ...
     if($_GET["phanloaiHD"]=='5'||$_GET["phanloaiHD"]=='6'||$_GET["phanloaiHD"]=='11')//thuốc ngoại trú)
              {
                 echo ('
            <td colspan="5"style="height:21px!important" ><b>'. number_format($totalTruocVAT,"0",",",".").'</b></td>'
                      );

              }
              elseif ($_GET["phanloaiHD"]=='1'||$_GET["phanloaiHD"]=='7'||$_GET["phanloaiHD"]=='9')
               {//khám chữa bệnh
                echo ('
...
<?php
 ...
 if($_GET["phanloaiHD"]=='5'||$_GET["phanloaiHD"]=='11')//thuốc ngoại trú)
            ...
            <td  align="center" colspan="1"style="height:21px!important; margin-right:20px" ><b>'. number_format($thongtinnv3[count($thongtinnv3)-1]["PhanTramThue"],"0",",",".") .'</b></td>'
              ...
              elseif ($_GET["phanloaiHD"]=='1'||$_GET["phanloaiHD"]=='7'||$_GET["phanloaiHD"]=='6'||$_GET["phanloaiHD"]=='9')
               {//khám chữa bệnh
                echo ('
...
?>
           ...
           <td colspan="4" style="text-align:right"><b><?=number_format($totalTruocVAT*$thongtinnv3[count($thongtinnv3)-1]["PhanTramThue"]/100,"0",",","." ) ?></b></td>
        </tr>
...
<?php
     ...
     if($_GET["phanloaiHD"]=='5'||$_GET["phanloaiHD"]=='6'||$_GET["phanloaiHD"]=='11')//thuốc ngoại trú)
              {
                 echo ('
            <td colspan="5"style="height:21px!important" ><b>'. number_format((int)($totalTruocVAT+($totalTruocVAT*$thongtinnv3[count($thongtinnv3)-1]["PhanTramThue"]/100)),"0",",",".").'</b></td>'
                      );
...
$TotalCuoiCung=0;
 if($_GET["phanloaiHD"]=='5'||$_GET["phanloaiHD"]=='6'||$_GET["phanloaiHD"]=='11')//thuốc ngoại trú)
              {
        $TotalCuoiCung=(int)($totalTruocVAT+($totalTruocVAT*$thongtinnv3[count($thongtinnv3)-1]["PhanTramThue"]/100));
