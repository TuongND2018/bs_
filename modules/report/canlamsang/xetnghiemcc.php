                    ...
                    if($zo=="0"){
                        if($thongtinluotkham[$i]['ID_LoaiKham']=="3746"){
                          ...
                          for($j=0;$j<=count($thongtinluotkham)-1;$j++){
                            if($thongtinluotkham[$j]['ID_XetNghiem']=="22166"){
                                 $RBC=$thongtinluotkham[$j]['KetQua'];
                                 $dem++;
                            }
                            else if($thongtinluotkham[$j]['ID_XetNghiem']=="22167"){
                                 $HGB=$thongtinluotkham[$j]['KetQua'];
                                 $dem++;
                            }
                            else if($thongtinluotkham[$j]['ID_XetNghiem']=="22168"){
                                 $HCT=$thongtinluotkham[$j]['KetQua'];
                                 $dem++;
                            }
                            else if($thongtinluotkham[$j]['ID_XetNghiem']=="22176"){
                         ...
                         // echo $dem;
                          echo ('<tr style=" border-top:2px solid #000;"> <td width="240px" colspan="1"><b style="margin-left:10px">'.$thongtinluotkham[$i]['TenLoaiKham'].' <br>'.$thongtinluotkham[$i]['NgayGioTao'].'</b></td>');
                          if($dem>="4"){
                        ...
                        if($thongtinluotkham[$i]['ID_Kham']==$thongtinluotkham[$i-1]['ID_Kham']){
                            ...
                            echo ('<tr style=" border-top:2px solid #000;"> <td colspan="1" width="240px"><b style="margin-left:10px">'.$thongtinluotkham[$i]['TenLoaiKham'].' <br>'.$thongtinluotkham[$i]['NgayGioTao'].'</b></td>');
                             if($thongtinluotkham[$i]['ID_LoaiKham']=="3746"){
                                 for($j=0;$j<=count($thongtinluotkham)-1;$j++){
                            if($thongtinluotkham[$j]['ID_XetNghiem']=="22166"){
                                 $RBC=$thongtinluotkham[$j]['KetQua'];
