...
<body>
    ...
    <div style="width:100%;height:50%" align="center">
            <div id="clound" style="padding-top: 77px"></div>
                <div style="width:588px;float:left; margin-top:5px;margin-left:20px" >
                <div class="top">
                    <div class="bottom">
                        <div class="left">
                            <div class="right">
            ...
            <div style="width:448px;float:right;margin-top:5px;margin-right:20px" >  
            ...
            <div style="width:448px;margin-top:5px" >
                <div class="top">
                    <div class="bottom">
                        <div class="left">
                            <div class="right">
        ...
        $(document).ready(function() {
          //  load_sign('<?=$thongtinluotkham[0]["chuky_bacsy"]?>',"bs_chandoan");            
            ...
            _split_link= _links.split(":::");
                ...
                $("#conner4").append(' <img id="myImg'+0+'" width="550px" height="580px" src="'+_split_link[3]+'"  /> ');
                 $("#conner5").append(' <img id="myImg'+1+'"  width="410px" height="274px"src="'+_split_link[4]+'"  /> ');
                 $("#conner6").append(' <img id="myImg'+2+'"  width="410px"  height="274px" src="'+_split_link[5]+'"  /> ');
