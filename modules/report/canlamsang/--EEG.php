...
<body>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Tahoma, Geneva, sans-serif;">
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="font-size:13px; width:100%;font-family:Tahoma, Geneva, sans-serif;padding:5px 0px";>   
     	 <tr>
         	<td width="75%" style="height:390px;vertical-align:top" >
            	<label style=" font:11px Tahoma, Geneva, sans-serif;font-weight:bold">NEUROMAP(Tỷ lệ - Abs và biên dộ - Rel của các loại sóng ở từng khu vực não)</label>
                <div id="images_container"></div>
                <div style="height:128px"></div>
                <label style=" font:11px Tahoma, Geneva, sans-serif;font-weight:bold">HISTOGRAM(Biên độ - Microvol của các loại sóng ở từng khu vực não)</label>
            </td>
         ...
         <tr>
            ...
            <td width="308" valign="top" style=" margin-left:20px;width:65%;padding-top:10px;" colspan="2" >
            ...
            <tr>
                ...
                <td align="center" >
                	 <img id="bs_chandoan" width="159"/>aaaaa
                </td>
