...
#conner4,#conner5,#conner6,#conner7{
...
<body>
    ...
    <div style="width:100%;" align="center">
           ...
           <div style="width:900px;margin-top:10px;" > 
            <div style="width:438px;float:left;margin-right:5px;margin-bottom:5px" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
			...
			<div style="width:438px;float:left;margin-bottom:5px" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
		...
		<div style="width:900px" > 
            <div style="width:438px;float:left;margin-right:5px;" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
	...
	</div>	<!-- <div id="clound2" style="height:150px;margin-top:523px"></div> -->
</body>
</html>
        ...
        $(document).ready(function() {
          //  load_sign('<?=$thongtinluotkham[0]["chuky_bacsy"]?>',"bs_chandoan");            
            ...
            _split_link= _links.split(":::");
                ...
                $("#conner4").append(' <img id="myImg'+0+'" width="400px" height="270px"src="'+_split_link[3]+'"  /> ');
                 $("#conner5").append(' <img id="myImg'+1+'"  width="400px" height="270px" src="'+_split_link[4]+'"  /> ');
                 $("#conner6").append(' <img id="myImg'+2+'"  width="400px" height="270px" src="'+_split_link[5]+'"  /> ');
                 $("#conner7").append(' <img id="myImg'+3+'"  width="400px" height="270px" src="'+_split_link[6]+'"  /> ');
