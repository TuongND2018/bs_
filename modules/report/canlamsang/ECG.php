...
<body style="height:500px">
		...
		<table  style="background:transparent">
        	<tr>
            	<td>
               	  <pre style="background:transparent; font-size:15px!important; font-style:italic;vertical-align:top;border:NONE;margin-left:216px;margin-top:85px;width:516px;" READONLY><?=  $thongtinluotkham[0]["KetLuan"]."\n"?><b><?=$code15[0]["ExtField2"]?></b>
				  </pre>
                ...
                <td valign="top" rowspan="2">
                	 <div style="margin-top:4px">
                        <span style="letter-spacing: 0.5px;font-weight:bold;font-size:12px!important;color:#00b3a0">FAMILY</span> <img src="images/logo_mau.png"  /> 
                        
                        <div style="letter-spacing: 0.2px;text-transform:uppercase;font-size:13px!important;font:13px Tahoma, Geneva, sans-serif;"><b><?php echo $_SESSION["com"]["TenBenhVien"]?></b></div>
                      </div>
