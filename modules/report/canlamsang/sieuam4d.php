...
Phụ trách: BS Nguyễn Văn Thụy. Tu nghiệp tại Pháp và Mỹ. Giáo sư thỉnh giảng đại học UTMB, Galveston, Texas<br></i></div>
    <?php if($_GET["header"]=="left"){ ?>
        <div style="font-size:14px;font-family:Arial,Tahoma, Geneva, sans-serif;-webkit-transform: rotate(270deg);-moz-transform: rotate(270deg);-o-transform: rotate(270deg);writing-mode: rl-tb;position:absolute;top:550px;left:-380px">  <span style="letter-spacing: 0.5px;font-weight:bold;color:#00b3a0">FAMILY</span> <img src="images/logo_mau.png" />  <span style="letter-spacing: 0.5px;text-transform:uppercase"><?php echo $_SESSION["com"]["TenBenhVien"]?></span> - <?php echo $_SESSION["com"]["DiaChi"]?> * T: <?php echo $_SESSION["com"]["SoDT"]?></div>
    <?php } ?>
    <?php if($_GET["header"]=="top"){ ?>   
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial,Tahoma, Geneva, sans-serif;">
     ...
     <?php  } ?>
     <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial,Tahoma, Geneva, sans-serif;color:#0E71B2">
        <tr>
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="color:#036;line-height:2;font-size:13px; width:100%;font-family:Arial,Tahoma, Geneva, sans-serif; border-top:1px solid #000; border-bottom:1px solid #000; padding:5px 0px">         
         <tr>
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="font-size:13px; width:100%;font-family:Arial,Tahoma,arial, Geneva, sans-serif;padding:5px 7px">         
         <tr>
            <td valign="top" style="width:65%;padding-top:10px">
                ...
                <br /><br />
                <b style="font-size:15px;color:#0E71B2">KẾT LUẬN</b><br />
                <pre><b><?=$thongtinluotkham[0]["KetLuan"] ?></b></pre>
                <br /><br />
                <b style="font-size:15px;color:#0E71B2"><?=$denghi?></b><br />
