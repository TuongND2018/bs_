...
<body>
    ...
    <div style="width: 100%;overflow: hidden;margin-top:20px">
        <div id="clound" style="width:12%;height:990px;float:left"></div>
        <div style="width:76%;float:left" align="center">
               ...
               <div style="width:538px;margin-top:5px" > 
        ...
        <div id="clound2" style="width:12%;height:990px;float:left"></div>
    </div>
        ...
        $(document).ready(function() {
          //  load_sign('<?=$thongtinluotkham[0]["chuky_bacsy"]?>',"bs_chandoan");            
            ...
            _split_link= _links.split(":::");
                ...
                $("#conner4").append(' <img id="myImg'+0+'" width="500px" height="600px" src="'+_split_link[3]+'"  /> ');
                 $("#conner5").append(' <img id="myImg'+1+'"  width="230px" height="300px" src="'+_split_link[4]+'"  /> ');
                  $("#conner6").append(' <img id="myImg'+2+'"  width="230px" height="300px" src="'+_split_link[5]+'"  /> ');
               print_preview();
