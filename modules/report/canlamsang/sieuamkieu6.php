...
#conner4,#conner5,#conner6,#conner7,#conner8,#conner9{
...
<body>
    ...
    <div id="clound"style="width:12%;height:990px;float:left;margin-top:10px"></div>
    <div style="float:left;width:74%;margin-top:10px">
    <div style="width:100%;height:50%" align="center">
			
				<div style="width:338px;float:left;margin-top:10px;margin-left:5px" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
            ...
            <div style="width:208px;float:left;margin-top:10px;margin-right:5px" >  
			...
			<div style="width:208px;margin-top:44px" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
		...
		<div style="width:100%;height:50%;float:left;margin-top:10px" align="center">
            ...
            <div style="width:208px;float:left;margin-right:5px;margin-top:5px" >  
            <div style="width:208px;;margin-top:5px" >
				<div class="top">
					<div class="bottom">
						<div class="left">
							<div class="right">
		...
		<div id="clound2" style="width:12%;height:990px;float:left;margin-top:10px"></div>
        ...
        $(document).ready(function() {
          //  load_sign('<?=$thongtinluotkham[0]["chuky_bacsy"]?>',"bs_chandoan");            
            ...
            _split_link= _links.split(":::");
                ...
                $("#conner4").append(' <img id="myImg'+3+'" width="300px" height="432px"src="'+_split_link[3]+'"  /> ');
                 $("#conner5").append(' <img id="myImg'+4+'"  width="170px" height="180px" src="'+_split_link[4]+'"  /> ');
                 $("#conner6").append(' <img id="myImg'+5+'"  width="170px" height="180px" src="'+_split_link[5]+'"  /> ');
                 $("#conner7").append(' <img id="myImg'+6+'"  width="300px" height="432px" src="'+_split_link[6]+'"  /> ');
                 $("#conner8").append(' <img id="myImg'+7+'"  width="170px" height="180px" src="'+_split_link[7]+'"  /> ');
                  $("#conner9").append(' <img id="myImg'+8+'"  width="170px" height="180px" src="'+_split_link[8]+'"  /> ');
