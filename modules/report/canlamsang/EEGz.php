...
<body>
	...
	<?php if($_GET["header"]=="left"){ ?>
		<div style="font-size:14px;font-family:Tahoma, Geneva, sans-serif;-webkit-transform: rotate(270deg);-moz-transform: rotate(270deg);-o-transform: rotate(270deg);writing-mode: rl-tb;position:absolute;top:550px;left:-382px">  <span style="letter-spacing: 0.5px;font-weight:bold;color:#00b3a0"">FAMILY</span> <img src="images/logo_mau.png" />  <span style="letter-spacing: 0.5px;text-transform:uppercase"><?php echo $_SESSION["com"]["TenBenhVien"]?></span> - <?php echo $_SESSION["com"]["DiaChi"]?> * T: <?php echo $_SESSION["com"]["SoDT"]?></div>
	<?php } ?>
         ...
         <tr>
         	<td width="50%" style="padding-top:0px; text-align:center" valign="top">
            	 ...
            	 <b>
                  ...
                  <div><img id="bs_chandoan" width="120" height="60px"/></div>
         	 ...
         	 <td width="50%" style="padding-top:0px; text-align:center" valign="top">
                 ...
                 <b>
                  ...
                  <div><img id="ng_thuchien" width="120px" height="60px"/></div>
                 <b><?=$thongtinluotkham[0]["NguoiThucHien"];?></b>
            </td>  
