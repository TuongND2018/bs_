...
<body>
 ...
 <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif;">
    ...
    <table  cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        <tr>
           ...
           <b style="padding-right:35px">BÁC SỸ</b>

            <br><img id="nv_chandoan" width="130"/>
            <br><strong><?php echo $khamthai[0]["VietTat"].' '.$khamthai[0]["HoLotNhanVien"].' '.$khamthai[0]["TenNhanVien"];  ?></strong>
            </td>
 ...
 <script type="text/javascript">
    ...
    load_sign('<?=$khamthai[0]["HinhChuKy"]?>',"nv_chandoan");
           print_preview();
    });
</script>