...
<body>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Tahoma, Geneva, sans-serif;">
         <tr style="font-size:14px;">
            ...
            <td width="44%" style="text-align:center;font-family:Tahoma, Geneva, sans-serif;letter-spacing: 0.5px;font-weight:bold;font-size:26px;color:#00b38b;vertical-align:bottom">
                <span><?php echo $_GET["tieude"]?></span>
                <br />
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="font-size:13px; width:100%;font-family:Tahoma, Geneva, sans-serif;padding:5px 0px";>   
     	 <tr>
            ...
            <td width="30%" align="center" style="font:11px Tahoma, Geneva, sans-serif;font-weight:500">
            	<img src="./modules/report/canlamsang/eeg.JPG" width="200px" height="220px">
            ...
            <td width="70%" style="height:360px;vertical-align:top" >
                ...
                <br />
                <b style="font-size:15px;color:#00b38b">KẾT LUẬN</b>
