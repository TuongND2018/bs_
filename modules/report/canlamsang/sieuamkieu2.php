...
<body>
    ...
    <div style="width:100%;margin-top:3%;" align="center">
           ...
           <div style="width:956px;margin-top:3%" > 
        ...
        $(document).ready(function() {
          //  load_sign('<?=$thongtinluotkham[0]["chuky_bacsy"]?>',"bs_chandoan");            
            ...
            _split_link= _links.split(":::");
                ...
                $("#conner4").append(' <img id="myImg'+0+'" width="440px" height="500px" src="'+_split_link[3]+'"  /> ');
                 $("#conner8").append(' <img id="myImg'+1+'"  width="440px" height="500px" src="'+_split_link[4]+'"  /> ');
