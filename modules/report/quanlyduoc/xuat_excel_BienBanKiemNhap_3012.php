...
<div id="wrapper">
    ...
    <table border="0" cellpadding="0" cellspacing="0" align="center" style="width:800px;margin-top:5px"">
    	<tr>
        	...
        	<td width="40%" colspan="3" align="center" style="font-size:12px; font-weight:bold">&nbsp;</td>
        	<td colspan="3" align="center" style="font-size:12px; font-weight:bold">CỘNG HÒA XÃ HỘI CHỦ NGHĨ VIỆT NAM</td>
            
        </tr>
    	<tr>
    	  <td colspan="5" align="center" style="font-size:12px; font-weight:bold">BỆNH VIỆN ĐA KHOA GIA ĐÌNH ĐÀ NẴNG</td>
        ...
        <tr>
        	<td colspan="11" align="left" style="font-size:14px;">
             ...
             tại Khoa dược Bệnh viện Đa Khoa Gia Đình Đà Nẵng, chúng tôi gồm các thành viên hội đồng <br />kiểm nhập hàng sau, gồm các khoản cụ thể:</td>
        </tr>
</table>
...
<table border="0" cellpadding="0" cellspacing="0" align="center" style="width:800px;margin-top:5px"">
  <tr>
    ...
    <td colspan="2" align="center"><strong>HC,Dược,mua hàng</strong></td>
