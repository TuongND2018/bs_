...
<div id="wrapper">
    ...
    <table border="1" cellpadding="0" cellspacing="0" align="center" style="width:1500px;margin-top:5px">
        ...
        foreach ($tam as $row) {//duyet toan bo mang tra ve
			...
			if($tenthuoc!=$row['TenBietDuoc']){
				if($slton==0){
					$slton=$slton+$row['SL_TON'];	
				}
				$tieude= '<tr>
				<td colspan="19">
				<b> + '.$tenthuoc.'<b> - Số lượng tồn: '.$slton.'
				</td>
				</tr>';
			...
			$stt++;
			if($kiemtracuoi==count($tam)){
				$tieude= '<tr>
				<td colspan="19">
				<b> + '.$row['TenBietDuoc'].'<b> - Số lượng tồn: '.$slton.'
				</td>
				</tr>';
				echo $tieude;
				echo $chuoi;
