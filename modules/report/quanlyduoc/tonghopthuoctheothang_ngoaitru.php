...
<?php
	...
	$store_name="{call GD2_BaoCaoTongHopTHuoc_theo_Thang_NgoaiTru (?,?)}";//tao bien khai bao store
...
<body>
            <div style="width:100%;text-align:center">
                    <span  style="font-weight:bold;font-size:16px">  TỔNG HỢP THUỐC NGOẠI TRÚ HẰNG THÁNG</span><br />
...
<?php
		if($types=="excel"){
			...
			$exp->exportWithPage("excel/temp.html","TongHopThuocTheoThang_NgoaiTru_".$_GET['thang']."_".$_GET['nam'].".xls");
		}
	?>