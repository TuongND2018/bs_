...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhVLTLByID_LuotKham(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamVLTLByID_LuotKham(?)}";//tao bien khai bao store
