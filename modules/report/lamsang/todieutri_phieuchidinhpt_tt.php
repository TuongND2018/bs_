...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhPT_GTByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamPT_GTByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
 ...
 <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif;">
	...
	<h2 style="text-align:center; font-family:Arial, Helvetica, sans-serif;">CHỈ ĐỊNH PHẪU THUẬT-THỦ THUẬT</h2>
   ...
   <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
		...
		?>
				<tr>
					...
					<td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#F5F5F5" <?php }?>   style=" width:58%; text-align:left; padding-left:2px; padding-top:2px; padding-bottom:2px;padding-right:2px;">
				   <?=$ttcd["TenLoaiKham"]; ?>
					</td>
