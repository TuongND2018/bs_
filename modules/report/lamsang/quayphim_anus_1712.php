    ...
    <script type="application/javascript">
		$(document).ready(function() {
			...
			for(i=0;i<=_split_link.length-2;i++){	
				if(i==0){		 
					$("#images_container").append(' <img width="200px" height="180px" src="'+_split_link[i]+'"  /><div style="height:7px;margin-bottom: 25px;"><b>THÌ NGHĨ</b></div> ');
					
				}
				if(i==1){		 
					$("#images_container").append(' <img width="200px" height="180px" src="'+_split_link[i]+'"  /><div style="height:7px"><b>THÌ RẶN</b></div> ');
