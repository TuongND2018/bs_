...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhPT_GTByID_LuotKham(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamPT_GTByID_LuotKham(?)}";//tao bien khai bao store
