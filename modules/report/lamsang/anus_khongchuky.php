...
<body>
	...
	<?php if($_GET["header"]=="left"){ ?> 
		<div style="font-size:14px;font-family:Arial, Geneva, sans-serif;-webkit-transform: rotate(270deg);-moz-transform: rotate(270deg);-o-transform: rotate(270deg);writing-mode: rl-tb;position:absolute;top:490px;left:-385px">  <span style="letter-spacing: 0.5px;font-weight:bold;color:#00b3a0">FAMILY</span> <img src="images/logo_mau.png" />  <span style="letter-spacing: 0.5px;text-transform:uppercase"><?php echo $_SESSION["com"]["TenBenhVien"]?></span> - <?php echo $_SESSION["com"]["DiaChi"]?> * T: <?php echo $_SESSION["com"]["SoDT"]?></div>
	<?php } ?>
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="font-size:13px; width:100%;font-family:Arial, Geneva, sans-serif;padding:5px 0px">         
         <tr>
            <td valign="top" style="width:65%;padding-top:10px">
                ...
                <b style="font-size:15px;color:#00b38b">KẾT QUẢ SOI</b>:
                <div>
                <?php
				...
				?>	<i><pre><b>+ Đặc điểm hậu môn: </b><br /><?=$thongso[0]["DacDiemHauMon"]?></pre>
                    </i>
                <?php
				}
				?>
                <i><pre><b>+ Đặc điểm trực tràng: </b><br /><?php if($thongso[0]["ThongSoKyThuat"]){?><?php }?><?=$thongso[0]["ThongSoKyThuat"]?></pre></i>
               <?php 
			   	if($thongso[0]["MoTa"]!=""){
			   ?>
                <i><b>+ Các đặc điểm khác: </b><?=$thongso[0]["MoTa"]?></i>
                <?php
				}
				?>
                </div>
