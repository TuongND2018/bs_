...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhDTPHByID_LuotKham(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamDTPHByID_LuotKham(?)}";//tao bien khai bao store
