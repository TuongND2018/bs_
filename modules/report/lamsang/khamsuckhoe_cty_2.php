...
<body>
    ...
    ?>
     ...
     <tr>
     	<td width="50%" style="padding-left:15px; padding-top:8px;">
          <strong style=" font-size:13px; padding-top:5px; padding-bottom:8px; text-transform: uppercase;"><?php if(count($thongtincty)){ echo $thongtincty[0]['TenCty'];} ?></strong>
         <?php
		 if(count($thongtincty)){
			  if(mb_strlen($thongtincty[0]['TenCty'], 'UTF-8')<45)
			  {
			  ?>
			  <br />&nbsp;
			  <?php
       ...
       <td align="center" width="50%" style="font-weight:bold; font-size:13px;padding-left: 50px;"> 
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:arial, Geneva, sans-serif;font-size:13px;">
        ...
        <?=$thongtinbenhnhan[0]['ID_BenhNhan'];?>
        </strong></td>
      </tr>
      <tr>
        <td>Địa chỉ:</td>
...
<tr>
    ...
    <td ><input type='text' class='nam'> năm</td>
</tr>
</table>
