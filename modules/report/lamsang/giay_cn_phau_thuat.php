...
<table width="100%" border="0" cellpadding="0" cellspacing="0" height="90!important">
  <tr style="vertical-align:top; "  height="100%!important" >
    ...
    <td>
	  <table border="1" cellpadding="0" cellspacing="0" height="500" width="95%" style="float:right; font-family:Tahoma, Geneva, sans-serif;">
      ...
      <tr>
        <td colspan="2" align="center" valign="middle" style="font-size:18px"><strong>GIẤY CHỨNG NHẬN PHẪU THUẬT</strong></td>
        </tr>
