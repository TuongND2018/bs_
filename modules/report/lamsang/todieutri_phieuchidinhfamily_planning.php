...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhfamily_planningByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamfamily_planningByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
