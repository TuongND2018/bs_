     ...
     <table cellpadding="0" cellspacing="0" border="0" style=" margin-left:auto; margin-right:auto;font-size:14px; width:90%;font-family:Tahoma, Geneva, sans-serif; border-top:1px solid #000; border-bottom:1px solid #000; padding:5px 0px">         
       <tr height="28px">
         <td style=" width:60%"> Họ tên: <b><?=$thongtinbenhnhan[0]["HoLotBenhNhan"]." ".$thongtinbenhnhan[0]["TenBenhNhan"];?></b></td> 
            ...
            <td align="left" style=" width:10%">Giới: <?=$thongtinbenhnhan[0]["Gioi"];?></td>
            <td align="left" style=" width:20%">ID: <?=$thongtinbenhnhan[0]["MaBenhNhan"];?></td>
         </tr>
         <tr height="28px" >
          ...
          <tr height="28px">
            <td colspan="2" width="80%">Chẩn đoán:&nbsp;&nbsp;<?=$thongtinluotkham[0]["ChanDoan"] ?></td>   
      ...
      <table border="0" cellpadding="0" cellspacing="0" style="font-size:13px; margin-left:35px; width:100%;font-family:Tahoma, Geneva, sans-serif">    
         ...
         <tr>
            ...
            <br>
            <b style="font-size:15px;">TÓM TẮT PHẪU THUẬT-THỦ THUẬT</b>
                <br />
          ...
          <tr>
                ...
                <td align="center" >
				<b style="color:red"><?=$thongtinluotkham[0]["NguoiThucHien"] ?>
                </td>
