...
<body>
	<?php
		...
		$params1 = array($_GET["idtodieutrichitiet"]);//tao param cho store 
        $store_name1="{call GD2_SelectChiDinhDTPHByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
		...
		$params2 = array($_GET["idtodieutrichitiet"]);//tao param cho store 
        $store_name2="{call GD2_SelectThongTinLuotKhamDTPHByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
 ...
 <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif;">
	...
	<h2 style="text-align:center; font-family:Arial, Helvetica, sans-serif;">CHỈ ĐỊNH ĐIỀU DƯỠNG</h2>
    <table  cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        <tr >
            <td style=" width:55%;  padding-top: 1px;  padding-bottom: 1px;"><?=$thongtinluotkham[0]["TenPhanLoaiKham"]; ?></td>
        	<td style=" width:45%; text-align:right;  padding-top: 1px;  padding-bottom: 1px;"><?php if($thongtinbenhnhan[0]["TD"]!=''){ echo $thongtinbenhnhan[0]["TD"].'/'.$thongtinbenhnhan[0]["KT"].'/'.$thongtinbenhnhan[0]["HL"];} ?> </td>
        </tr>
        <tr>
            <td style=" width:55%; font-weight:bold;  padding-top: 1px;  padding-bottom: 1px;"><?=$thongtinbenhnhan[0]["HoLotBenhNhan"].' '.$thongtinbenhnhan[0]["TenBenhNhan"]; ?> </td>
        	<td style=" width:45%; text-align:right;font-weight:bold;  padding-top: 1px;  padding-bottom: 1px; font-size:16px;"><?=$thongtinbenhnhan[0]["MaBenhNhan"];?> </td>
        </tr>
        <tr>
            <td style=" width:55%;  padding-top: 1px;  padding-bottom: 1px;"><?=$thongtinbenhnhan[0]["Tuoi"];?> tuổi, <?=$thongtinbenhnhan[0]["Gioi"];?> </td>
        	<td style=" width:45%; text-align:right;  padding-top: 1px;  padding-bottom: 1px;"><?=$thongtinluotkham[0]["ThoiGianVaoKham"]->format("H:i ".$_SESSION["config_system"]["ngaythang"]); ?> </td>
        </tr>
    </table>
    <br />
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
        <tr style="border-bottom:solid 1px #000000 !important; font-weight:bold;">
            ...
            <td style=" width:5%; text-align:left; padding-left:2px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important;  padding-top:2px; padding-bottom:2px;">
            L
            </td >
            <td style=" width:5%; text-align:left; padding-left:2px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important;  padding-top:2px; padding-bottom:2px;">
            N
            </td >
            <td style=" width:15%; text-align:left;padding-left:2px; border-bottom:solid 1px #000000 !important;; border-top:solid 1px #000000 !important;  padding-top:2px; padding-bottom:2px;">
            P.Thức
            </td >
		...
		?>
				<tr>
               		<td style=" width:7%; text-align:left; padding-left:10px;padding-top:2px; vertical-align:top;"><?=$i;?></td>
					<td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#F5F5F5" <?php }?>   style=" width:48%; text-align:left; padding-left:2px; padding-top:2px; padding-bottom:2px;">
				   <?=$ttcd["TenLoaiKham"]; ?>
					</td>
					<td  style=" width:5%; text-align:left; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["SoLanThucHienTrongNgay"]; ?>
					</td>
                    <td  style=" width:5%; text-align:left; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["SoNgayThucHien"]; ?>
					</td>
                    <td  style=" width:15%; text-align:left; padding-left:2px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["PhuongThucThucHien"]; ?>
					</td>
                    <td  style=" width:20%; text-align:right; padding-right:10px;  padding-top:2px; padding-bottom:2px; vertical-align:top;">
				   <?=$ttcd["NickName"]; ?>
					</td>
				</tr>
        <?php
		...
		?>
         ...
         <tr>
        	<td  style=" width:100%; border-bottom:solid 1px #000000 !important;" colspan="6">
            </td>
        </tr>
    </table>
    <br />
