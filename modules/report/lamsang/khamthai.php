...
/*		if($thongtinluotkham[0]["NgayGioKetThuc"]){
	...
	<?php if($_GET["header"]=="left"){ ?>
		<div style="font-size:14px;font-family:Arial, Geneva, sans-serif;-webkit-transform: rotate(270deg);-moz-transform: rotate(270deg);-o-transform: rotate(270deg);writing-mode: rl-tb;position:absolute;top:550px;left:-340px">  <span style="letter-spacing: 0.5px;font-weight:bold">FAMILY</span> <img src="images/logo_print.png" />  <span style="letter-spacing: 0.5px;text-transform:uppercase"><?php echo $_SESSION["com"]["TenBenhVien"]?></span> - <?php echo $_SESSION["com"]["DiaChi"]?> * T: <?php echo $_SESSION["com"]["SoDT"]?></div>
	<?php } ?>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Geneva, sans-serif;">
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Geneva, sans-serif;color:#00b38b">
     	<tr>
             <td style="text-align:center; height: 100px; line-height:25px; vertical-align:bottom; padding-top:10px;">
                <span style="letter-spacing: 0.5px;font-weight:bold;font-size:26px;">PHIẾU KHÁM THAI</span>	
                <br />
                <span style="font-weight:bold;font-size:20px;">(OBSTETRICS REPORT)</span>
                <br />
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="color:#036;font-size:15px; width:100%;font-family:Arial, Geneva, sans-serif; border-top:1px solid #000; border-bottom:1px solid #000; padding:5px 0px">         
         <tr>
            ...
            <td>&nbsp;</td>
            <td>ID: <strong>
            <?=$thongtinbenhnhan[0]["MaBenhNhan"]."_".date("dmyHi");?>
            </strong></td>
         </tr>
         <tr>
            <td  style="width:60%">Địa chỉ: <?=$thongtinbenhnhan[0]["DiaChi"];?></td> 
            <td>&nbsp;</td> 
            <td colspan="2">
            Ngày khám:  <?php
			if($thongtinluotkham[0]["NgayGioThucHien"]!=""){
            	echo $thongtinluotkham[0]["NgayGioThucHien"]->format($_SESSION["config_system"]["ngaythang"]);
			}
			?>
            </td>           
         </tr>
         <tr>
         	<td colspan="4">
            HA: <?=$thongtinbenhnhan[0]["Ps"].'/'.$thongtinbenhnhan[0]["Pd"].' mmHg';?> - Mạch <?=$thongtinbenhnhan[0]["Mach"].' lần/phút';?>
             - Nặng <?=$thongtinbenhnhan[0]["CanNang"].' kg';?> - Cao <?=$thongtinbenhnhan[0]["ChieuCao"].' cm';?>
     ...
     <table cellpadding="0" cellspacing="0" border="0" style="font-size:14px; width:100%;font-family:Arial, Geneva, sans-serif;padding:5px 0px">         
         <tr>
            <td valign="top" style="width:65%;padding-top:10px">
                ...
                <tr>
                    <td colspan="2" style=" font-family:Arial, Helvetica, sans-serif;font-size:15px;color:#00b38b; font-weight:bold; margin:0px; height:27px">THÔNG TIN BỆNH</td>
                  </tr>
                 <?php
                ...
                <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td colspan="2" style=" font-family:Arial, Helvetica, sans-serif;font-size:15px;color:#00b38b; font-weight:bold; margin:0px; height:27px">KẾT QUẢ KHÁM </td>
                </tr>
                    <tr>
                ...
                <b style="font-size:15px;color:#00b38b">KẾT LUẬN</b><pre style="margin-top: 5px; margin-bottom: -10px;"><b><?=$khamthai[0]["KetLuan"] ?></b></pre><br />
                <b style="font-size:15px;color:#00b38b">ĐỀ NGHỊ</b><br />
