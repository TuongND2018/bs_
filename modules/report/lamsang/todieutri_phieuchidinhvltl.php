...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhVLTLByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamVLTLByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
 ...
 <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif;">
	...
	<h2 style="text-align:center; font-family:Arial, Helvetica, sans-serif;">CHỈ ĐỊNH VLTL</h2>
