...
<?php
	...
	$params3 = array($_GET['idphieulinh']);//tao param cho store 
	$store_name3="{call GD2_GetTenKhoaByID_PhieuLinh(?)}";//tao bien khai bao store
	...
	$params2 = array($_GET['idphieulinh'],1);//tao param cho store 
	...
	$params21 = array($_GET['idphieulinh'],2);//tao param cho store 
	$store_name21="{call GD2_GetLinhThuocByID_PhieuLinhThuoc(?,?)}";//tao bien khai bao store
	...
	$params22 = array($_GET['idphieulinh'],3);//tao param cho store 
	$store_name22="{call GD2_GetLinhThuocByID_PhieuLinhThuoc(?,?)}";//tao bien khai bao store
	...
	?>
     <div id="page_1" class="page" style="page-break-after: always; padding-left: 10px; padding-top:5px">
         <div class="n_top">
            ...
            <table  width="700px" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td style="text-align:center; font-weight:bold; font-size:20px">
                        PHIẾU LĨNH THUỐC - VẬT TƯ Y TẾ<br />
            ...
            <table width="700px" border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td>- Tên tôi là: <strong><?=$thongtin[0]['HoTenNguoiLinh']?></strong></td>
              </tr>
              <tr>
                <td>- Đơn vị công tác: <strong><?=$thongtin[0]['TenPhongBan']?></strong></td>
              </tr>
              <tr>
                <td>- Đối tượng bệnh nhân xin cấp: <strong><?=$thongtin[0]['LoaiDoiTuongKham']?></strong></td>
              </tr>
            </table><br />
        </div>
		   ...
		   ' <table width="700px" border="0" cellpadding="0" cellspacing="0">'+
			 ...
			 '   <td style="text-align:center"><strong>NGƯỜI LĨNH</strong></td>'+
			  ...
			  '<tr>'+
			   ' <td>&nbsp;</td>'+
				'<td>&nbsp;</td>'+
				'<td style="text-align:center"> <strong><?=$thongtin[0]['HoTenNguoiLinh']?></strong></td>'+
				'<td>&nbsp;</td>'+
			  '</tr>'+
		 '   </table>'+
	  '  </div>');
