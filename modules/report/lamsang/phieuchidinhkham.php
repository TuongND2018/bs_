 ...
 <table cellpadding="0" cellspacing="0" border="0" style="width:100%;font-family:Arial, Helvetica, sans-serif;">
    ...
    <table cellpadding="0" cellspacing="0" style="width:100%;font-family:Arial, Helvetica, sans-serif; font-size:12px;">
			...
			if($ttcd["XetNghiem"]==1){
                ...
                <tr>
                  <td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#CCCCCC" <?php }?>  style=" width:3px; text-align:left; padding-top:2px; padding-bottom:2px; vertical-align:top;"><?=$i?></td>
                    <td <?php if($ttcd["ID_TrangThai"]=='Xong') {?>bgcolor="#CCCCCC" <?php }?>  style=" width:70%; text-align:left; padding-left:10px; padding-top:2px; padding-bottom:2px;">
                   <?=$ttcd["TenLoaiKham"]; ?>
                    </td>
                    <td  style=" width:30%; text-align:right; padding-right:10px;  padding-top:2px; padding-bottom:2px;vertical-align:top;">
                   <?=$ttcd["NickName"]; ?>
                    </td>
		...
		?>
         ...
         <tr>
        	<td  style=" width:100%; border-bottom:solid 1px #000000 !important;" colspan="3">
            </td>
        </tr>
    </table>
    <br />
