...
<body>
	<?php
        ...
        $store_name1="{call GD2_SelectChiDinhXetNghiemByID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
        ...
        $store_name2="{call GD2_SelectThongTinLuotKhamByXetNghiemAndID_ToDieuTriChiTiet(?)}";//tao bien khai bao store
