...
?> </b></td>
  ...
  <tr>
    <td colspan="2">-BHYT:&nbsp;&nbsp;&nbsp;giá trị từ:      /     /     đến     /    /  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  Số: <input class="input_style" type="text" name="soBHYT1" id="soBHYT1" value="<?=$tbh1;?>"/><input class="input_style" type="text" name="soBHYT2" id="soBHYT2" value="<?=$tbh2;?>"/><input class="input_style" type="text" name="soBHYT3" id="soBHYT3" value="<?=$tbh3;?>"/><input class="input_style" type="text" name="soBHYT4" id="soBHYT4" value="<?=$tbh4;?>"/><input class="input_style" type="text" name="soBHYT5" id="soBHYT5" value="<?=$tbh5;?>"/></td>
    </tr>
  <tr>
