...
switch ($_GET["oper"]) {
    case "add":
        add("GD2_spGoiKhamChoCongTy_Insert");
        break;
    case "edit":
        edit("GD2_spGoiKhamChoCongTy_Update");
        break;
    case "del":
        del("GD2_spGoiKhamChoCongTy_Delete");
        break;
}	 		 
...
function add($store_name){	
	...
	$chuoi="(";
	$i=0;
	if($_POST["NgayBatDau"]!="") $_POST["NgayBatDau"]=convert_date($_POST["NgayBatDau"]);
	if($_POST["NgayKetThuc"]!="") $_POST["NgayKetThuc"]=convert_date($_POST["NgayKetThuc"]);
	if($_POST["NgayGioTao"]!="") $_POST["NgayGioTao"]=convert_date($_POST["NgayGioTao"]);
