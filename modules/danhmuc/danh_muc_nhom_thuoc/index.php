...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_nhomthuoc',
		datatype: "json",	
			   ...
			   afterSubmit : function(response, postdata) { 
				...
				afterShowForm : function (formid) {
					...
					autocompleted_combobox("#ID_NhomThuocCha,#ID_VAT");
					  ...
					  links='resource.php?module=danhmuc&view=danh_muc_nhom_thuoc&id_form=47&id_loai=undefined';
					  ...
					  links='resource.php?module=danhmuc&view=danh_muc_VAT&id_form=47&id_loai=undefined';
					  elem=1 + Math.floor(Math.random() * 1000000000); 
					  width=90;
					  height=90;  
...
function load_select2(){
	window.nhomthuoccha = $.ajax({url: 'resource.php?module=web_services&function=get_auto_edit_option&action=index&term=&status=2&tables=DM_NhomThuoc&id=ID_NhomThuoc&name=TenNhomThuoc', async: false, success: function(data, result) {if (!result) alert('Không load được danh mục nhóm thuốc');}}).responseText;	
...
function load_select3(){
	window.thuevat = $.ajax({url: 'resource.php?module=web_services&function=get_auto_edit_option&action=index&term=&status=2&tables=DM_ThueVAT&id=ID_VAT&name=VAT', async: false, success: function(data, result) {if (!result) alert('Không load được danh mục VAT');}}).responseText;	
...
function load_select(){
		window.nation2 = $.ajax({url: 'resource.php?module=web_services&function=get_auto_edit_option&action=index&term=&status=0&tables=DM_NhomThuoc&id=ID_NhomThuoc&name=TenNhomThuoc', async: false, success: function(data, result) {if (!result) alert('Không load được danh mục nhóm thuốc');}}).responseText;	
		window.nation3 = $.ajax({url: 'resource.php?module=web_services&function=get_auto_edit_option&action=index&term=&status=0&tables=DM_ThueVAT&id=ID_VAT&name=VAT', async: false, success: function(data, result) {if (!result) alert('Không load được danh mục VAT');}}).responseText;
}
