...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["ID_Thuoc"],$row["TenHoatChat"],$row["TenDonViTinh"],$row["BHYTNoiTruOrNgTru"],$row["Giaban"],$row["Ngayapdung"],$row["NickName"],$row["Active"],$row["TenBietDuoc"]);
    $i++; 
}
