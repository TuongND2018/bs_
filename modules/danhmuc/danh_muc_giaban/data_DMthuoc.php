...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["TenBietDuoc"],$row["HoatChatChinh"],$row["MaThuoc"],$row["ID_DuongDung"],$row["DonGia"],$row["ID_DonViTinh"],$row["LaThuoc"],$row["ThuocBHYT"],$row["TenDonViTinh"]);
    $i++; 
}   
