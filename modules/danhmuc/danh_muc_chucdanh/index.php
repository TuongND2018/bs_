...
jQuery(window).resize(function() {		 
	...
	$("#rowed3").jqGrid('navButtonAdd', '#prowed3', {caption: "Excel", buttonicon: 'ui-icon-calculator', id : 'search_rowed3',
            onClickButton: function() {			 
				window.open('http://192.168.1.104:81/giaidoan2/resource.php?module=report&view=danhmuc&action=in_danh_muc_chuc_danh&id_form=a&type=excel');
            },
...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_chucdanh',
		datatype: "json",	
