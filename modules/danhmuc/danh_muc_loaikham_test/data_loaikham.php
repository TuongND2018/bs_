...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["ID_LoaiKham"],$row["TenLoaiKham"],$row["MaVietTat"],$row["MaVietTat_BN"],$row["ID_NhomCLS"],$row["MoTa"],$row["GiaBaoChoBN"],$row["GiaThueNgoaiThucHien"],$row["ThoiGianTrungBinhThucHien"],$row["ThoiGianCoKetQua"],$row["GhiChu"],$row["LoiKhuyen"],$row["Active"],$row["STT"],$row["CLS"],$row["XetNghiem"],$row["CoLuuKQInRieng"],$row["DieuTriTaiNha"],$row["CoMauNhapKQ"],$row["PathToTemplateFile"],$row["TenLoaiKham_EN"],$row["ReportName"],$row["ID_auto"]);
    $i++; 
}
