...
jQuery(document).ready(function() {
  ...
  var columns = [  		
			...
			{name:'TenBietDuoc',id:'TenBietDuoc',field: "TenBietDuoc",width: 150, formatter: TaskNameFormatter},	 
			//{name:'Barcode',id:'Barcode',field: "Barcode",width: 150},	 
			{name:'TenGoc',id:'TenGoc',field: "TenGoc",width: 150},	
			//{name:'TenHoaDon',id:'TenHoaDon',field: "TenHoaDon",width: 150},			
			{name:'HoatChatChinh',id:'HoatChatChinh',field: "HoatChatChinh",width: 150},				               
			{name:'DonGia',id:'DonGia',field: "DonGia",width: 60},
            {name:'ID_NuocSanXuat',id:'ID_NuocSanXuat',field: "ID_NuocSanXuat",width: 120},			
            {name:'QuyCach',id:'QuyCach',field: "QuyCach",width: 70},
            {name:'ID_NhomBenh',id:'ID_NhomBenh',field: "ID_NhomBenh",width: 100},
			{name:'ID_DonViTinh',id:'ID_DonViTinh',field: "ID_DonViTinh",width: 110},
            {name:'ID_HangSanXuat',id:'ID_HangSanXuat',field: "ID_HangSanXuat",width: 120},
			//{name:'SignNumber',id:'SignNumber',field: "SignNumber",width: 90},
            {name:'ID_DuongDung',id:'ID_DuongDung',field: "ID_DuongDung",width: 110},	
			{name:'TonKhoToiThieu',id:'TonKhoToiThieu',field: "TonKhoToiThieu",width:110},
			{name:'GhiChu',id:'GhiChu',field: "GhiChu",width: 60},
            {name:'HeSoDieuChinhGiaBan',id:'HeSoDieuChinhGiaBan',field: "HeSoDieuChinhGiaBan",width: 150},
            ...
            {name:'PhanTramThue',id:'PhanTramThue',field: "PhanTramThue",width: 110},
			{name:'LaThuoc',id:'LaThuoc',field: "LaThuoc",width: 60}, 
			{name:'Active',id:'Active',field: "Active",width: 50}, 
			{name:'DoUuTien',id:'DoUuTien',field: "DoUuTien",width: 80},
			{name:'ThuocBHYT',id:'ThuocBHYT',field: "ThuocBHYT",width: 90},
			{name:'BHYTNoiTruOrNgTru',id:'BHYTNoiTruOrNgTru',field: "BHYTNoiTruOrNgTru",width: 150},
 ...
 function filter(item) {
  ...
  $(grid.getHeaderRow()).delegate(":input", "change keyup", function (e) {
      ...
      if (columnId != null) {
		...
		//$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_thuoc_search',columnFilters).done(function(a){
        ...
        $('#list10_d').jqGrid('setGridParam', {url: 'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_thuochc&id='+id_edit,datatype:'json'}).trigger('reloadGrid');
        $('#rowed5').jqGrid('setGridParam', {url: 'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_thuoc_phanloaithuoc&id='+id_edit,datatype:'json'}).trigger('reloadGrid');
        $('#dialog-form').dialog('open');
        ...
        var ID_HangSanXuat = dataView.getItem(args.row).ID_HangSanXuat;
