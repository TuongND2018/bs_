...
function add($store_name){
        ...
        $params = array(
           ...
           trim($_POST['hansudung']," "),//@HanSuDung nvarchar(50),
          ...
          $_POST['hesodieuchinhgiaban'],//@HeSoDieuChinhGiaBan decimal(18,0),
           $_POST['hesodieuchinhgiaban_hoadon'],//@HeSoDieuChinhGiaBan_HoaDon DECIMAL(18,0),
           $_POST['dongia_hoadon'],//@DonGia_HoaDon DECIMAL(18,0),
           ...
           trim($_POST['signnumber']," "),//@SignNumber	nvarchar(50),
...
function edit($store_name){
	...
	$params = array( 
           ...
           $_POST['hamluong'],
           trim($_POST['hansudung']," "),
           trim($_POST['dongia']," "),
           $_POST['tonkhotoithieu'],
           trim($_POST['douutien']," "),
           trim($_POST['ghichu']," "),
           $_POST['hesodieuchinhgiaban'],
           $_POST['hesodieuchinhgiaban_hoadon'],
           $_POST['dongia_hoadon'],
          $_POST['phantramthue'],
           trim($_POST['quycach']," "),
           $lathuoc,
           ...
           trim($_POST['signnumber']," "),
          // trim($_POST['ID_NhomPhanLoaiThuoc']," "),
