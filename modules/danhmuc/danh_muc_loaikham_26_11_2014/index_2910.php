     		...
     		<div class="form_row" style="vertical-align:top"  >
       		 ...
       		 <div class="form_row" style="vertical-align:top"  >
                   ...
                   <div style="padding-top:10px ">
		               ...
		               <input id="MauBaoHiem" name="MauBaoHiem"  type="text" style="width:170px;margin-left:5px">
		           </div>
		           <div style="padding-top:10px ">
...
function create_grid(){	
	 $("#rowed3").jqGrid({
		...
		datatype: "json",	
		colNames:['Id','Tên loại khám','Mã viết tắt','Mã viết tắt bệnh nhân','Thuộc nhóm','Mô tả','Giá báo BN','Giá thuê ngoài','Số phút thực hiện','Thời gian có kết quả','Ghi chú','Lời khuyên','Sử dụng','STT','CLS','Xét Nghiệm','Có lưu kết quả in riêng','Điều trị tại nhà','Có mẫu nhập kết quả','Đường dẫn của tập tin mẫu','Tên loại khám bằng tiếng anh','Report name','Có thể kê toa','Thuộc nhóm xếp hạng CLS','Điều chỉnh giá khám','Phụ phí khám tại nhà','Điều chỉnh giá tại nhà ','Có form chức năng riêng','Số phim lớn tiêu hao','Số phim nhỏ tiêu hao','Số phim nhũ ảnh tiêu hao','Tuyến huyện','Tuyến tỉnh','Tuyến trung ương','Giá bảo hiểm','Giá phụ thu bệnh viện','Nhóm BHYT','Tên BHYT','Màu BHYT'],
		colModel:[
                        ...
                        {name:'CoTheKeToa',index:'CoTheKeToa', width:"100%",stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:8, colpos:2},editoptions: {value:"1:0"}},
                        {name:'ThuocNhomXepHangCLS',index:'ThuocNhomXepHangCLS', width:"100%", stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'},stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'},editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:9, colpos:2},editoptions: {value:"1:0"}},
                        {name:'PhanTramDieuChinhGiaTaiNha',editrules: {required:true},index:'PhanTramDieuChinhGiaTaiNha', width:"100%", editable:true,align:'right',hidden:false,edittype:"text",formoptions:{ rowpos:11, colpos:1}},
                        {name:'PhuThuThucHienTaiNha',editrules: {required:true},index:'PhuThuThucHienTaiNha', width:"100%", editable:true,align:'right',hidden:false,edittype:"text",formoptions:{ rowpos:12, colpos:1}},
                        {name:'GiaTaiNhaDieuChinhTheoNhom',index:'GiaTaiNhaDieuChinhTheoNhom',stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, width:"100%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", defaultValue: '0'},formoptions:{ rowpos:10, colpos:2},editoptions: {value:"1:0"}},
                        {name:'CoFormChucNangRieng',index:'CoFormChucNangRieng', width:"100%", editable:true,align:'center',hidden:false,stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'},edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:11, colpos:2},editoptions: {value:"1:0"}},
                        {name:'SoPhimLonTieuHao',index:'SoPhimLonTieuHao', width:"100%",formatter:'currency', editable:true,align:'left',hidden:false,edittype:"text",formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", defaultValue: '0'},formoptions:{ rowpos:12, colpos:2}},
                        {name:'SoPhimNhoTieuHao',index:'SoPhimNhoTieuHao', width:"100%",formatter:'currency', editable:true,align:'left',hidden:false,edittype:"text",formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", defaultValue: '0'},formoptions:{ rowpos:13, colpos:1}},
                        {name:'SoPhimNhuAnhTieuHao',index:'SoPhimNhuAnhTieuHao', width:"100%", editable:true,align:'left',hidden:false,edittype:"text",formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", defaultValue: '0'},formoptions:{ rowpos:13, colpos:2}},
                        {name:'TuyenHuyen',index:'TuyenHuyen', width:"100%",stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:4, colpos:2},editoptions: {value:"1:0"}},
                        {name:'TuyenTinh',index:'TuyenTinh', width:"100%",stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:4, colpos:2},editoptions: {value:"1:0"}},
                        {name:'TuyenTrungUong',index:'TuyenTrungUong', width:"100%",stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:4, colpos:2},editoptions: {value:"1:0"}},
                        ...
                        {name:'GiaPhuThuBenhVien',index:'GiaPhuThuBenhVien',editrules: {required:true}, width:"60%", editable:true,align:'right',hidden:false,edittype:"text",formoptions:{ rowpos:14, colpos:2}},
                        {name:'ID_Nhom_BHYT',index:'ID_Nhom_BHYT',editrules: {required:true}, width:"60%", editable:true,align:'center',hidden:false,edittype:"select",editoptions: { value: nation2},formoptions:{ rowpos:15, colpos:1, elmsuffix:'<a id="add_new" class="fm-button ui-state-default ui-corner-all " style="margin-left:30px!important;vertical-align:top;width:16px;height:13px;"  ><span style="margin-top:-2px;margin-right:-22px!important" class="ui-icon ui-icon-circle-plus"></span></a>'} },
						{name:'TenBaoHiem',index:'TenBaoHiem',editrules: {required:true}, width:"60%", editable:true,align:'right',hidden:false,edittype:"text",formoptions:{ rowpos:14, colpos:2}},
						{name:'MauBaoHiem',index:'MauBaoHiem',editrules: {required:true}, width:"60%", editable:true,align:'right',hidden:false,edittype:"text",formoptions:{ rowpos:14, colpos:2}},
