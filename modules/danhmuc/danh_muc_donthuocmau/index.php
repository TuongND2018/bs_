...
jQuery(document).ready(function() {
	...
	jQuery(window).resize(function() {		 
		...
		$("#rowed3").setGridHeight($(window).height()-$("#form_danh_muc_phong_ban").height()-230);
		$("#rowed5").setGridWidth($(window).width()-110);
		$("#rowed5").setGridHeight($(window).height()-$("#form_danh_muc_phong_ban").height()-490);
		$("#rowed4").setGridWidth($(window).width()-10);
		$("#rowed4").setGridHeight($(window).height()-$("#gbox_rowed3").height()-350);	
	})
        $( "#dialog-form" ).dialog({
            autoOpen: false,
...
function create_grid(){	
	...
	$("#rowed3").setGridWidth($(window).width()-10);
	$("#rowed3").setGridHeight($(window).height()-$("#form_danh_muc_phong_ban").height()-330);
...
function create_detail_grid(){	
	...
	$("#rowed4").setGridWidth($(window).width()-10);
	$("#rowed4").setGridHeight($(window).height()-$("#gbox_rowed3").height()-130);	
}
