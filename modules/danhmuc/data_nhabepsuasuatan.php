...
foreach ($tam as $row) {//duyet toan bo mang tra ve
    ...
    $responce->rows[$i]['cell']=array($row["ID_SuatAn"],$row["Ngay"],$row["TenPhongBan"],$row["NguoiChiuTien"],$row["TenThucDon"],$row["SoLuong"],$row["DonGia"],$row["ThanhTien"],$row["TrangThai2"],$row["NguoiDat"],$row["NguoiSua"],$row["NgayGioSua"],$row["NguoiHuy"],$row["NgayGioHuy"],$row["KieuBuoi"] ); 
    $i++; 
}
