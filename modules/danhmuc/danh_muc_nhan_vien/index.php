   	...
   	<div class="ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix"> <span id="ui-id-5" class="ui-dialog-title">Thông tin nhân viên</span> </div>
         ...
         <div class="form_row" style="vertical-align:top"  >
           ...
           <div style="padding-top:10px ">
               ...
               <input id="manv" name="manv" disabled type="text" style="width:140px;margin-left:5px;">
           </div>
...
function create_grid(){	
    ...
    deltext: 'Xóa (F8)',refreshtext: 'Tải lại (F10)', edit: permission["edit"], del: permission["delete"], search: false,closeAfterEdit: true,clearAfterAdd :true,navkeys : [ true, 38, 40 ],closeOnEscape : true,
        addfunc: function(){
            $.getJSON( "resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_max_manv", 
        function( data ) {
            ...
            $("#manv").css("background-color","#A4A4A4");
            $("input:text").val("");
            $("textarea").val("");
            $("#dantoc").val(1);
...
function check_n(){
		  ...
		  dataToSend += "," + '"hinhnhanvien":' + JSON.stringify(hinh_nhanvien) + '';
         dataToSend += "," + '"chukynv":' + JSON.stringify(chuky_nhanvien) + '';
