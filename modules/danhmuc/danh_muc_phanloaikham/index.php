...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_phanloaikham',
		datatype: "json",	
		colNames:['ID_PhanLoaiKham','Tên phân loại khám','Ghi chú','Sử dụng','Độ ưu tiên','Có khám lâm sàng','Có lấy sinh hiệu','Xác định nhân thân','Khám lâm sàng không phí'],
		colModel:[
                        {name:'ID_PhanLoaiKham',index:'ID_PhanLoaiKham',search:false, width:"2%", editable:false,align:'right',hidden:true},
			{name:'TenPhanLoaiKham',index:'TenPhanLoaiKham', width:"20%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
                        {name:'GhiChu',index:'GhiChu', width:"30%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{ rowpos:2, colpos:1}},		
			{name:'Active',index:'Active', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:3, colpos:1},editoptions: {value:"1:0"}},
                        {name:'STT',index:'STT', width:"10%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{ rowpos:2, colpos:2}},
                        {name:'CoKhamLamSang',index:'CoKhamLamSang', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:3, colpos:2},editoptions: {value:"1:0"}},
			{name:'CoLaySinhHieu',index:'CoLaySinhHieu', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:4, colpos:1},editoptions: {value:"1:0"}},		
                        {name:'CoXacDinhNhanThan',index:'CoXacDinhNhanThan', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:4, colpos:2},editoptions: {value:"1:0"}},
                        {name:'KhamLamSangKhongPhi',index:'KhamLamSangKhongPhi', width:"7%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:5, colpos:1},editoptions: {value:"1:0"}},
    ],
	//
	...
	//jsonReader:{repeatitems:true,subgrid:{repeatitems:false}},	
		...
		caption: "Danh Mục Phân Loại Khám"
	});	
			   ...
			   afterSubmit : function(response, postdata) { 
				...
				afterShowForm : function (formid) {
					...
					$("#sKhuvuc").click(function(e){		 
						...
						links="resource.php?module=danhmuc&view=danh_muc_phanloaikham&id_form=12"
