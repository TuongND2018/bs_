...
jQuery(window).resize(function() {		 
	...
	$("#rowed3").jqGrid('navButtonAdd', '#prowed3', {caption: "Excel", buttonicon: 'ui-icon-calculator', id : 'search_rowed3',
            onClickButton: function() {			 
				window.open('resource.php?module=report&view=danhmuc&action=in_danh_muc_dinh_muc_giam_gia&type=excel');
            },
...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_dinhmuc',
		datatype: "json",
		...
		colModel:[
			...
			{name:'TenQuotaGiamGia',index:'TenQuotaGiamGia',search:true, width:"20%", editable:true,align:'center',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
