     	...
     	<div id="container">
     		<div class="form_row" style="vertical-align:top"  >
		           ...
		           <div style="padding-top:10px ">
		               ...
		               <textarea id="MoTa" style="height:52px; width:170px;margin-left:5px" name="MoTa"></textarea>
		           </div>
		           <div style="padding-top:45px ">
		               <label for="GhiChu" style="width:140px;text-align:right; vertical-align:top; margin-top:20px">Ghi chú</label>
		               <textarea id="GhiChu" style="height:52px; width:170px;margin-left:5px" name="GhiChu"></textarea>
		           </div>                            
       		 </div>
       		 <div class="form_row" style="vertical-align:top"  >
             		<div style="padding-top:10px ">
		           ...
		           <div style="padding-top:10px ">
		               ...
		               <textarea id="ReportName"  style="height:60px; width:170px;margin-left:5px" name="ReportName"></textarea>
		           </div>
		             
		           <div style="padding-top:55px "> <label for="PhanTramDieuChinhGiaTaiNha" style="width:140px;text-align:right ">Điều chỉnh giá khám</label>
