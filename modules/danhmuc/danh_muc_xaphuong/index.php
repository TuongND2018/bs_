...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_xaphuong',
		datatype: "json",	
		...
		colModel:[
			...
			{name:'TenXaPhuong',index:'TenXaPhuong', width:"15%", editable:true,align:'center',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			   ...
			   afterSubmit : function(response, postdata) { 
				...
				afterShowForm : function (formid) {
					...
					$("#add_new").click(function(e){
					   $.post('resource.php?module=web_services&function=get_link&action=index&folder=danh_muc_quanhuyen:').done(function(data) {
