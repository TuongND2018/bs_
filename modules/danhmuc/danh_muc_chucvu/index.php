...
function create_grid(){	
	 $("#rowed3").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_chucvu',
		datatype: "json",	
		colNames:['Id','<?php get_text("tenchucvu")?>','<?php get_text1("mota")?>','<?php get_text1("sudung")?>','<?php get_text("stt")?>','ID4Dev'],
		colModel:[
			{name:'ID_ChucVu',index:'ID_ChucVu',search:false, width:"2%", editable:false,align:'right',hidden:true}, 
			{name:'TenChucVu',index:'TenChucVu', width:"20%", editable:true,align:'left',hidden:false,editrules: {required:true},edittype:"text",formoptions:{ rowpos:1, colpos:1}}, 
			{name:'MoTa',index:'MoTa', width:"30%", editable:true,align:'left',hidden:false,edittype:"textarea",formoptions:{ rowpos:2, colpos:1}},	 
			{name:'Active',index:'Active', width:"10%", editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:3, colpos:1},editoptions: {value:"1:0"},stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}},	
			{name:'STT',index:'STT', width:"10%", editable:true,align:'center',hidden:false,edittype:"text",formoptions:{ rowpos:4, colpos:1},defaultvalue:''},	
			{name:'ID4Dev',index:'ID4Dev', width:"10%", editable:false,align:'left',hidden:true,edittype:"text", formatter:"text",editoptions: {value:"1:0"},formoptions:{ rowpos:5, colpos:1}},		
		],
	//
		...
		caption: "<?php get_text("dm_chucvu")?>"
	});	
