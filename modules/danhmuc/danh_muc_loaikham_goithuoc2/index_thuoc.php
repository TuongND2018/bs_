...
function create_grid(){	
		$("#rowed3").jqGrid({
			...
			datatype: "json",
			colNames:['Chọn','','','','Id','Mã đơn','Tên đơn thuốc','Nhóm bệnh','Mô tả','Bác sĩ tạo','Là toa chuẩn','Áp dụng','Ghi chú'],
			colModel:[
			{name:'Chon',index:'Chon', width:"4%", editable:true,stype: 'text',search:false,searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:true,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formatoptions:{disabled: false},formoptions:{ rowpos:13, colpos:1}
			...
			{name:'ID_BacSiTao',index:'ID_BacSiTao', width:"4%", editable:false,align:'left',hidden:false,editrules: {required:true},edittype:"select",formatter:"select",editoptions:{value:idnhanvien}},
