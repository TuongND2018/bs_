...
function create_grid(){	
	 $("#rowed3").jqGrid({
		...
		datatype: "json",	
		colNames:['Id','Tên loại khám','Mã viết tắt','Mã viết tắt bệnh nhân','Thuộc nhóm','Mô tả','Giá báo BN','Ghi chú','Lời khuyên','Sử dụng','CLS','Xét Nghiệm','Tên loại khám bằng tiếng anh','Report name','Giá bảo hiểm','Tên BHYT',''],
		colModel:[
