...
function create_grid(datalocal){ 
	 datalocal=jQuery.parseJSON(datalocal);  
	  ...
	  datatype: "jsonstring" ,	
    	...
    	colModel:[
		{name:'ID_Control',index:'ID_Control', width:"1%", align:'left',hidden:true,formatter:"select",edittype:"select",key:true},
		{name:'Caption',index:'Caption', width:"3%",editrules: {required:true}, editable:true,align:'left',hidden:false},
