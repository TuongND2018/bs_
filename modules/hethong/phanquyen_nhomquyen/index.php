 ...
 $('#gbox_rowed4 .ui-search-table').find(':input[type=text]').each(function(){  
    ...
    function create_grid(){	
	 $("#rowed3").jqGrid({
	    ...
	    id_nhomquyen=id;				
		$("#rowed5").jqGrid('setGridParam',{datatype: "json",url:"resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_nhom_quyen&id_nhomquyen="+id_nhomquyen}).trigger('reloadGrid');	
		$("#rowed4").jqGrid('setGridParam',{datatype: "json",url:"resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_button&id="+0+"&id_nhomquyen="+0}).trigger('reloadGrid');						 
			var myGrid = $('#rowed3'),
	 ...
	 function create_grid1()
    {
        ...
        $("#rowed5").jqGrid({
			...
			$("#rowed4").jqGrid('setGridParam',{datatype: "json",url:"resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_button&id="+id+"&id_nhomquyen="+id_nhomquyen}).trigger('reloadGrid');		
...
$("#rowed5").jqGrid('navButtonAdd', '#prowed5', {caption: "Phân quyền cho nhóm quyền", buttonicon: '',	
    ...
    {
         $("#rowed4").jqGrid({
            url: 'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_button&id="+id+"&id_nhomquyen="+id_nhomquyen',		
            datatype: "json",
      ...
      $("#rowed4").setGridHeight($(window).height() - $("#kha").height()-380);
...
function savepermission(){
	...
	$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=save_quyen&id_nhomquyen='+id_nhomquyen+'&id_control='+selRowIds+'');
	 tooltip_message("Lưu dữ liệu thành công");
...
function savebutton(){
	...
	tam='{"id":'+tam+'}';
	tam=jQuery.parseJSON(tam);
	$.post('resource.php?module=<?=$modules?>&view=<?=$view?>&action=save_button&id_nhomquyen='+id_nhomquyen+'&id_parent='+id_parent+'&id='+selRowIds+'');
	tooltip_message("Lưu dữ liệu thành công");
