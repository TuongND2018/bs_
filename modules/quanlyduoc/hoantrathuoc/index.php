...
<input type="hidden" id="daxem2" >
  ...
  <div id="tabs-2">
   ...
   <div id="tabs-3">
    ...
    <input type="text" style="margin-left: 346px; margin-top: 3px; width: 115px;background:#4CA109;border:1px solid #327E04; color: #FFFFFF;font-weight: bold; text-align:right;" disabled="" readonly value="" class="disable" id="thanhtienban">
    <input type="text" style="margin-left: 230px; margin-top: 3px; width: 115px;background:#4CA109;border:1px solid #327E04; color: #FFFFFF;font-weight: bold; text-align:right;" disabled="" readonly value="" class="disable" id="thanhtienvon"></div></div> 
...
function create_grid6()
    {
        ...
        $("#rowed8").jqGrid({
            ...
            colModel: [
				...
				{name: 'ThanhTienBan', index: 'ThanhTienBan', search: false, width: "10%", editable: false, align: 'right', hidden: false,formatter:'currency',formatoptions:{decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", defaultValue: '0'}},
				{name: 'SLTraLai', index: 'SLTraLai', search: false, width: "10%", editable: false, align: 'right', hidden: false},
