...
function phieunhap(){ 
	...
	foreach ($tam as $row) {//duyet toan bo mang tra ve
		 ...
		 if($row["NgayDuyet"]==""){
			...
			$row["NgayDuyet"]=$row["NgayDuyet"]->format('d-m-Y');
		 }		 
		 if($row["NgayHoaDon"]==""){
			$row["NgayHoaDon"]=$row["NgayHoaDon"]; 
		 }else{
			
			$row["NgayHoaDon"]=$row["NgayHoaDon"]->format('d-m-Y');
		 }
		 if($row["NgayLapPhieu"]==""){
			$row["NgayLapPhieu"]=$row["NgayLapPhieu"]; 
		 }else{
			
			$row["NgayLapPhieu"]=$row["NgayLapPhieu"]->format('d-m-Y');
		 }
...
function phieunhap_sub(){ 
	...
	foreach ($tam as $row) {//duyet toan bo mang tra ve
		 ...
		 if($row["NgaySanXuat"]==""){
			...
			$row["NgaySanXuat"]=$row["NgaySanXuat"]->format('d-m-Y');
		 }
