...
function create_grid(){
		...
		colModel:[
			...
			{name:'DoiTuong',index:'DoiTuong',search:true, width:"15%", editable:false,align:'left',edittype:"text",hidden:false}, 
...
function create_grid2(){
		...
		colModel:[
			...
			{name:'DoiTuong',index:'DoiTuong',search:true, width:"15%", editable:false,align:'left',edittype:"text",hidden:false}, 
			{name:'SoPhieuTra',index:'SoPhieuTra',search:true, width:"5%", editable:false,align:'left',edittype:"text",hidden:true},
			{name:'ID_NhomPhanLoaiThuoc',index:'ID_NhomPhanLoaiThuoc',search:true, width:"5%", editable:false,align:'left',edittype:"text",hidden:true}, 
