...
<div id="dialog_sothuoc" style="display:none"></div>
  ...
  <tr>
    ...
    <td ><label>Số ngày thuốc BN yêu cầu:</label>
	</td>
  ...
  <tr>
    ...
    <td >
    	<input type="submit" name="intoathuoc" id="intoathuoc" value="Xem toa thuốc" style="color:#006; font-weight:bold">   
    </td>
  ...
  <tr>
    ...
    <td><input type="submit" name="inphieudieutri" id="inphieudieutri" value="In phiếu điều trị" >
     ...
     <td >
    <input type="submit" name="intoathuoc_hc" id="intoathuoc_hc" value="Xem toa thuốc(có hoạt chất chính)" style="color:#006; font-weight:bold">
    </td>
...
var arrary_enter1=[];
	...
	id_benhnhan=<?=$_GET['id_benhnhan']?>;
		...
		$.cookie("in_status", "print_preview");
		dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=dstoathuoc_intoathuoc&header=top&id_xuatkho="+id_xuatkho+"&id_donthuoc=<?= $_GET['ID_DonThuoc']?>&type=report&id_form=10&tenin=tengochoatchat&check="+id_check,'InDonThuoc_Bsy');
 ...
 function create_grid() {
		...
		datatype: "json",
		colNames:['Thuốc/vật tư','ĐVT','Cách dùng','SL/1ngày','SL BS kê','N.thuốc BNYC','SL BNYC','SL Xuất','SL Trả','SL Tg.Xuất','Đơn giá','T.Tiền theo BNYC','In','','','','','','','','','','','','','',''],
		colModel:[
			...
			{name:'slt_idphieuxuat',index:'slt_idphieuxuat',search:true, width:"5%", editable:false,align:'right',hidden:false},
