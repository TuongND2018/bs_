...
//        $("#rowed5").setGridHeight($(".right_col").height() - 60);
 ...
 function create_grid() {
        ...
        'Địa chỉ','BS','Ngày kê đơn', 'Tiền ĐT', 'Thực trả', 'Xuất', 'Ghi chú', 'Hồ sơ','Giờ in bill','','Xuất bởi','','Giờ xuất','Id_phieuxuat'],
            colModel: [
                ...
                {name: 'MaBenhNhan', index: 'MaBenhNhan', search: true, width: "5%", editable: false, align: 'left', hidden: false,sorttype:'integer'},
                {name: 'HoBenhNhan',  index: 'HoBenhNhan', search: true, width: "12%", editable: false, align: 'left', hidden: false},
				{name: 'TenBenhNhan',  index: 'TenBenhNhan', search: true, width: "5%", editable: false, align: 'left', hidden: false},
                {name: 'Tuoi', index: 'Tuoi', search: true, width: "3%", editable: false, align: 'right', hidden: false,sorttype:'integer'},
                {name: 'GioiTinh', index: 'GioiTinh', search: true, width: "3%", editable: false, align: 'center', hidden: false},
                {name: 'DiaChi', index: 'DiaChi', search: true, width: "16%", editable: false, align: 'left', hidden: false},
                {name: 'BSKeDon', index: 'BSKeDon', search: true, width: "5%", editable: false, align: 'left', hidden: false},
                {name: 'NgayKeDon', index: 'NgayKeDon', search: false, width: "8%", editable: false, align: 'center', hidden: false,formatoptions: {newformat: "H:i d/m/y", srcformat: 'H:i d/m/y',},formatter: 'date' ,searchoptions: {sopt: ['eq', 'ne'],},sorttype:'date',
},
                {name: 'TongTienTD', index: 'TongTienTD', search: true, width: "6%", editable: false, align: 'right', hidden: false,
				formatter : {

     currency : {decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", suffix:"", defaultValue: '0.00'},
				},sorttype:'currency'
				},
                {name: 'TongTienTT', index: 'TongTienTT', width: "7%", search: true, editable: false, align: 'right', hidden: false,sorttype:'currency'},
                {name: 'TThai', index: 'TThai',search:true, width:"5%",hidden:false},
                {name: 'GhiChu', index: 'GhiChu', search: true, width: "5%", editable: false, align: 'center', hidden: false},
                {name: 'HoSo', index: 'HoSo', search: true, width: "4%", editable: false, align: 'center', hidden: false},
				//{name: 'Bhiem', index: 'Bhiem',search:true, width:"2%",stype: 'select',searchoptions: { sopt: ['eq', 'ne'],value:':;1:Có;0:Không'}, editable:false,align:'center',hidden:false,edittype:"checkbox",formatter:"checkbox",formoptions:{ rowpos:7, colpos:1},editoptions: {value:"1:0"},formatoptions:{disabled: false}},
                
				/*{name: 'TienLapBill', index: 'TienLapBill', search: false, width: "0%", editable: false, align: 'right', hidden: true,sorttype:'currency'},*/
...
*/
           ...
           ondblClickRow: function(rowId) {
				...
				dialog_main("Bán lẻ theo đơn ", 100, 100, 567433265743657, "resource.php?module=<?=$modules?>&view=<?=$view?>&action=chitiet&type=test&id_form=22&ID_DonThuoc="+rowData['ID_DonThuoc']+"&id_benhnhan="+rowData['ID_BenhNhan']+"&ktx="+rowData['DaXuat']+"&islock="+rowData['IsLock']);
				},
