        ...
        <div id="top_main">
			<div class="form_row">
				<span>
					...
					<input type="text"  value="<?php echo date('d/m/Y');?>" style="width:109px" name="from_day" id='from_day'>
					<label for="to_day" style="width:49px"> Đến ngày</label>
					<input type="text"  value="<?php echo date('d/m/Y')?>" style="width:109px" name="to_day" id='to_day'>
                    ...
                    <button type="button" id="in_nhan_mau1">In nhãn mẫu 1</button>
                    <button type="button" id="in_nhan_mau2">In nhãn mẫu 2</button>
				</span>
           </div>
        </div>
        <div >
...
<script type="text/javascript">
    jQuery(document).ready(function() {
		...
		$('.xuatthuoctoatam').bind('click',function(){
			...
			$("#in_nhan_mau1").click(function(e) {
                $.cookie("in_status", "print_preview"); 
				dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=innhanthuoc&type=report&id_form=10",'InNhanThuoc');
            });
			
			$("#in_nhan_mau2").click(function(e) {
                $.cookie("in_status", "print_preview"); 
				dialog_report("Xem trước khi in",90,90,"u78787878975f","resource.php?module=report&view=<?=$modules?>&action=innhanthuoc2&type=report&id_form=10",'InNhanThuoc');
            });

        temp = jQuery(window).height()+490 ;
		phanquyen();
		$('#in_nhan_mau1,#in_nhan_mau2').button();
