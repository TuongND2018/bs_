...
function create_grid() {
	...
	$("#rowed3").jqGrid({
		...
		{name: 'MaPhieu', index: 'MaPhieu', search: false, width: "10%",  align: 'left', hidden: true},
...
function create_grid2() {
	...
	$("#rowed5").jqGrid({
		...
		colModel: [
		//{name: 'ID_Kham', index: 'ID_Kham', search: false, width: "8%", align: 'left', hidden: true},
		{name: 'MaPhieuChi', index: 'MaPhieuChi', search: false, width: "10%",  align: 'left', hidden: false},
		...
		{name: 'SoTienPC', index: 'SoTienPC', search: false, width: "15%",  align: 'right', hidden: false, formatoptions: {decimalSeparator:".", thousandsSeparator: ",", decimalPlaces: 0, prefix: "", suffix:"", defaultValue: '0'}
				,sorttype:'currency',formatter:'currency'
				},
		],
		loadonce: true,
