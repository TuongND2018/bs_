...
$begin_tran=$data->begin_tran();
		...
		$id_xuatkho='';
			...
			'',//   @GhiChu nvarchar(200),
			$_GET['tukho'],//   @ID_Kho int,
			88,//   @ID_LoaiNhapXuat int,
			'',//   @IDDonThuoc int,
			0,//   @DaThanhToan bit,
			$_GET['nguoiduyetxuat'],//   @ID_NguoiDuyet int,
		...
		$params6 = array($_GET['idxuatnoibo'],$id_xuatkho,$id_nhapkho);
		//print_r($params5);// id_nhapkho
