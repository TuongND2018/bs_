...
function create_grid() {
      mydata=[];
        $("#rowed3").jqGrid({
            data: mydata,
            datatype: "local",
            colNames: ['Tên thuốc','Đơn vị tính', 'Tồn kho tối thiểu', 'Tồn kho hiện tại', 'Tên nhà cung cấp', 'Điện thoại'],
            colModel: [
                {name: 'TenThuoc', index: 'TenThuoc', search: true, width: "25%", editable: false, align: 'left', hidden: false,classes:'abc'},
				{name: 'DonViTinh', index: 'DonViTinh', search: true, width: "15%", editable: false, align: 'center', hidden: false},
				{name: 'TonKhoToiThieu', index: 'TonKhoToiThieu', search: true, width: "15%", editable: false, align: 'right', hidden: false},
				{name: 'TonKhoHienTai', index: 'TonKhoHienTai', search: true, width: "15%", editable: false, align: 'right', hidden: false},
				{name: 'TenNhaCungCap', index: 'TenNhaCungCap', search: true, width: "15%", editable: false, align: 'center', hidden: false},
				{name: 'DienThoai', index: 'DienThoai', search: true, width: "15%", editable: false, align: 'center', hidden: false},
            ],
           loadonce: true,
            scroll: 1,
            modal: true,
