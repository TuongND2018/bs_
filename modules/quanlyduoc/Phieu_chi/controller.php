...
function updatecpn(){	
	...
	$_POST["ngaylapd2"]=$today['year'].'-'.$today['mon'].'-'.$today['mday'].' '.$today['hours'].':'.$today['minutes'];
	
	$check1='';
	//print_r($_POST);
	$data= new SQLServer;//tao lop ket noi SQL
	$store_name="{call [GD2_PhieuChiDuoc_Update_PhieuNhap] (?,?,?,?,?,?,?,?,?,?,?,?,?)}";//tao bien khai bao store
	$params = array( 
                 ($_POST["sotiend21"]),($_POST["nhaccd21"]),($_POST["tiend2"]),($_POST["nguoichid21"]),$_SESSION["user"]["id_user"],($_POST["ngaylapd2"]),($_POST["nguointd2"]),($_POST["diachid2"]),($_POST["dandod2"]),'PhieuChiDuoc',($_GET["maphieunhapkho"]),($_POST["id_thutrano"]),
...
function insertcpn(){	
	...
	$_POST["ngaylapd2"]=$_POST["ngaylapd2"].' '.$today['hours'].':'.$today['minutes'];
	
	$check1='';
	//print_r($_POST);
	$data= new SQLServer;//tao lop ket noi SQL
	$store_name="{call [GD2_PhieuChiDuoc_Insert_TraChoPhieuNhap] (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";//tao bien khai bao store
	$params = array( 
                 ($_POST["sotiend21"]),($_POST["nhaccd21"]),($_POST["tiend2"]),($_POST["nguoichid21"]),($_POST["ngaylapd2"]),($_POST["nguointd2"]),($_POST["diachid2"]),($_POST["dandod2"]),'PhieuChiDuoc',($_GET["maphieunhapkho"]),'0','0','0',
...
function insert(){	
	...
	$_POST["ngaylap"]=$_POST["ngaylap"].' '.$today['hours'].':'.$today['minutes'];
