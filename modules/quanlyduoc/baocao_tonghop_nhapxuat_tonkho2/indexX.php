...
function create_grid(){
	 ...
	 $("#rowed6").jqGrid({
		url:'resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_baocao_tonghop',
		//url:'',
		datatype: "json",
		colNames:['Mã thuốc','Tên thuốc',"ĐVT","Số lô HT","Số lô NSX", "Giá vốn",'Giá bán', "SL tồn đầu","TT tồn đầu","SL nhập trong kỳ",'TT nhập trong kỳ','SL xuất trong kỳ','TT xuất trong kỳ','SL tồn','TT tồn','Hạn sử dụng','ID nhà cung cấp','Nhà cung cấp','Ưu tiên xuất','Chỉnh sửa'],
		colModel:[

			{name:'MaThuoc',index:'MaThuoc', width:"60",align:'left',hidden:false, editable: false, frozen : true},
			{name:'TenThuoc',index:'TenThuoc', width:"200",align:'left', editable: false, frozen : true},
			{name:'TenDonViTinh',index:'TenDonViTinh',width:"50",align:'center',hidden:false, editable: false, frozen : true},
			{name:'SoLoHeThong',index:'SoLoHeThong', width:"70",align:'left', editable: false, frozen : true},
			{name:'SoLoNSX',index:'SoLoNSX', width:"70",align:'left', editable: false, frozen : true},
			{name:'GiaVon',index:'GiaVon', width:"70",formatter:'number', formatoptions:{decimalPlaces: 0},align:'right',hidden:false, editable: false,  summaryType:'sum', frozen : true},
			{name:'GiaBan',index:'GiaBan', width:"70",formatter:'number', formatoptions:{decimalPlaces: 0},align:'right',hidden:false, editable: false,  summaryType:'sum', frozen : true},
		...
		caption: "Danh sách thuốc <div id='xct' style='float:left; margin-top: -20px; margin-left: 15%;'><input type='checkbox' id='tenthuoc' /> Nhóm theo Tên biệt dược <input type='checkbox' id='nhacungcap' /> Nhóm theo nhà cung cấp <input type='checkbox' id='grouptatca' /> Nhóm theo nhà cung cấp và Tên biệt dược</div",
