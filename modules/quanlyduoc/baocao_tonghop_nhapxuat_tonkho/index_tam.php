...
jQuery(document).ready(function() {
  ...
  var columns = [  		
            ...
            {name:'Nước Sản Xuất',id:'NuocSanXuat',field: "NuocSanXuat",width: 120},			
            {name:'Quy Cách',id:'QuyCach',field: "QuyCach",width: 70},
            {name:'Nhóm Bệnh',id:'ID_NhomBenh',field: "ID_NhomBenh",width: 100},
			{name:'Đơn Vị Tính',id:'ID_DonViTinh',field: "TenDonViTinh",width: 110},
            {name:'Hãng Sản Xuất',id:'HangSanXuat',field: "HangSanXuat",width: 120},
			//{name:'SignNumber',id:'SignNumber',field: "SignNumber",width: 90},
            {name:'Đường Dùng',id:'ID_DuongDung',field: "ID_DuongDung",width: 110},	
