...
<!--	<div id="grid_phong_ban" style="width:2500px;">
          ...
          <div style="width:1330px;" id="slickgrid">
...
jQuery(document).ready(function() {
  ...
  var columns = [
			...
			{name:'Tên thuốc',id:'TenThuoc',field: "TenThuoc",width: 150, sortable: true},	 			
			{name:'ĐVT',id:'TenDonViTinh',field: "TenDonViTinh",width: 40},			
			{name:'Số lô HT',id:'SoLoHeThong',field: "SoLoHeThong",width: 90},	
			{name:'Số lô NSX',id:'SoLoNSX',field: "SoLoNSX",width: 75},                      
			...
			{name:'TT tồn đầu',id:'ThanhTienTonDau',field: "ThanhTienTonDau",width: 70,formatter: number,cssClass: "textright"},				 
            {name:'SL nhập trong kỳ',id:'SoLuongNhapTrongKy',field: "SoLuongNhapTrongKy",width: 60,formatter: number,cssClass: "textright"},
            {name:'TT nhập trong kỳ',id:'ThanhTienNhapTrongKy',field: "ThanhTienNhapTrongKy",width: 60,formatter: number,cssClass: "textright"},
			{name:'SL xuất trong kỳ',id:'SoLuongXuatTrongKy',field: "SoLuongXuatTrongKy",width: 60,formatter: number,cssClass: "textright"},
            {name:'TT xuất trong kỳ',id:'ThanhTienXuatTrongKy',field: "ThanhTienXuatTrongKy",width: 60,formatter: number,cssClass: "textright"},			
			...
			{name:'TT tồn',id:'ThanhTienTon',field: "ThanhTienTon",width: 60,formatter: number,cssClass: "textright"},
            {name:'Hạn sử dụng',id:'HanSuDung',field: "HanSuDung",width: 60},
            {name:'Ưu tiên xuất',id:'UuTienXuat',field: "UuTienXuat",width: 40},          
            {name:'Nhà cung cấp',id:'TenNhaCungCap',field: "TenNhaCungCap",width: 300},
 ...
 function filter(item) {
  ...
  $(function () {
	  ...
	  dataView.setGrouping({
		...
		aggregators: [
			...
			new Slick.Data.Aggregators.Sum("SoLuongTon")
		  ],
  ...
  $(grid.getHeaderRow()).delegate(":input", "change keyup", function (e) {
    ...
    dataView.beginUpdate();
		$.post("resource.php?module=<?=$modules?>&view=<?=$view?>&action=data_baocao_tonghop&from_day="+$("#from_day").val()+"&to_day="+$("#to_day").val()+"&tenkho=1&n_order=").done(function(data){
			data=$.parseJSON(data)
