...
function addbenhnhan(){			
	...
	if($("."+window.class_tab_focus).length){	
		...
		elem=1 + Math.floor(Math.random() * 1000000000);
		var folder= data.split(';');
	    var duong_dan='resource.php?module='+folder[0]+'&view='+folder[1]+'&id_form='+folder[2]+'&holot='+tam[1]+'&ten='+tam[2];		  				  
...
function editbenhnhan(){
	 ...
	 if($("."+window.class_tab_focus).length){	
		...
		elem=1 + Math.floor(Math.random() * 1000000000);
		var folder= data.split(';');
		var duong_dan='resource.php?module='+folder[0]+'&view='+folder[1]+'&id_form='+folder[2]+'&idbenhnhan='+tam[1]+'&oper=edit';				  				  
...
function taoluotkham(){
	...
	if($("."+window.class_tab_focus).length){						
		...
		elem=1 + Math.floor(Math.random() * 1000000000);
		var folder= data.split(';');
		var duong_dan='resource.php?module='+folder[0]+'&view='+folder[1]+'&id_form='+folder[2]+'&oper=add&id_benhnhan='+tam[1];				  		makeTabs.addTab('Lượt khám '+tam[2],'<div class="loading"><div id="loading"></div></div><iframe id="frame1" class="frame_'+elem+' src=""></iframe>','2_btn_datlichhenkham');				 
		callIframe(duong_dan, hide_loader,elem);
		 })				
	}				 
}
function editluotkham(){
	...
	if($("."+window.class_tab_focus).length){						
		...
		elem=1 + Math.floor(Math.random() * 1000000000);
		var folder= data.split(';');
		var duong_dan='resource.php?module='+folder[0]+'&view='+folder[1]+'&id_form='+folder[2]+'&oper=edit&id_ttluotkham='+tam[1];				  		makeTabs.addTab('Lượt khám '+tam[2],'<div class="loading"><div id="loading"></div></div><iframe id="frame1" class="frame_'+elem+' src=""></iframe>','2_btn_datlichhenkham');				 
		callIframe(duong_dan, hide_loader,elem);
		})	
	}				 			 
}
