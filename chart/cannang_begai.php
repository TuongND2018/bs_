...
//echo 'sssssssssssssssssssssssssssssssssssssssssssssssss'. $size.'dddddd';
//echo $size;
if (!empty($tam)) {
...
?>
	<head>
		<meta charset="utf-8">
		<title>Cân nặng bé gái theo tuổi</title>
...
<label   id='tt1' >  Họ và tên trẻ:" . $v["HoLotBenhNhan"] . " " . $v["TenBenhNhan"] ." </label><br>
        ...
        <label   id='tt3' >  Ngày tháng năm sinh:" . $v["NgayThangNamSinh"]->format("d/m/Y") . "</label>";
			...
			<?php if($veline == true){
				...
				/*chart.addPlot("plotLine", {type: "Lines", hAxis: "x2",markers: <?= $chuoi?>, vAxis: "y2", animate: {duration: 900}});
				chart.addSeries("Series X", chartLine, {plot: "plotLine" , stroke: {color:"black"}, fill: "#02c3ec"});*/
				...
				chart.addPlot("plot1", {type: "Areas",hAxis: "x2", vAxis: "y2", animate: {duration: 900}});
				 ...
				 <?php
				   ...
				   $heso1=1.8; $heso2=2.4;$heso3=4.5;$heso4=5;
						 ...
						 $temp[0]=1.94; $temp[1]=2.75; $temp[2]=3.5; $temp[3]=4.05; $temp[4]=4.5; $temp[5]=4.84;
						 $temp[6]=5.1; $temp[7]=5.35; $temp[8]=5.55; $temp[9]=5.73; $temp[10]=5.9; $temp[11]= 6.1; $temp[12]=6.25;
						 $temp[60]=12;
				...
				chart.addPlot("plot2", {type: "Areas", hAxis: "x2", vAxis: "y2", animate: {duration: 900}});
				  var chartData2=[];
                      <?php               						 
						 ...
						 $temp2[0]=2.2; $temp2[1]=3.2; $temp2[2]=3.96; $temp2[3]=4.55; 
                                                 $temp2[4]=5.05; $temp2[5]=5.45;
						 $temp2[6]=5.75; $temp2[7]=5.97; $temp2[8]=6.18; 
                                                 $temp2[9]=6.35; $temp2[10]=6.55; $temp2[11]=6.72; $temp2[12]=6.9;
						 $temp2[60]=13.8;
						 $cache_i=0;$kiemtra_khoangcach=false;
				...
				chart.addSeries("Series B", chartData2, {plot: "plot2" , stroke: {color:"#ffffff"}, fill: "#ffc600"});
				  var chartData3=[];
                    <?php               
						 ...
						 $temp3[0]=4.2; $temp3[1]=5.5; $temp3[2]=6.7; $temp3[3]=7.65; $temp3[4]=8.3; $temp3[5]=8.8;
						 $temp3[6]=9.32; $temp3[7]=9.8; $temp3[8]=10.2; 
                                                 $temp3[9]=10.53; $temp3[10]=10.85;
                                                 $temp3[11]=11.2; $temp3[12]=11.5;
						 $temp3[60]=25;
						 $cache_i=0;$kiemtra_khoangcach=false;
...
?>
 ...
 <body>   
    ...
    <div class="box_rotate">Cân nặng(kg)</div>
         ...
         <tr>
       	   <td height="40" style="width:90%"><h1 align="left" color="#ffc600">Cân nặng theo tuổi - Bé gái </h1></td>
    ...
    <div class="label_des">
         <label   id="t1" class="mauchung" >  Cân nặng cao hơn so với tuổi  </label>
          <label   id="t2" class="mauchung">  Cân nặng bình thường  </label>
          <label   id="t3" class="mauchung">  Suy dinh dưỡng vừa  </label>
        
   <label   id="t4" class="mauchung">  Suy dinh dưỡng nặng  </label>
