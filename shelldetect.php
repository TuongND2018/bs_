...
class shellDetector {
  ...
  private function version() {
    ...
    $server_version = file_get_contents('http://192.168.1.105:81/giaidoan2/PHP-Shell-Detector-master/version/app', 0, $context);
    ...
    $server_version = file_get_contents('http://192.168.1.105:81/giaidoan2/PHP-Shell-Detector-master/version/db', 0, $context);
